...
###################################
def listFilesInTOTEMCastor(castor_dir,type):
...
def listFilesCMS(local_dir,type):
...
def TOTEM_CMS_Combine_Files(castor_dir,local_dir,type):
    from subprocess import call
    f={}
    #mergeName=[]
    totemfiles = listFilesInTOTEMCastor(castor_dir,type)
    cmsfiles = listFilesCMS(local_dir,type)
