...
void CMS_MC_POMPYT_JPSI_plus_v5(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.0, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.0,const Double_t xi_proton_up_=0.2,const Int_t Bin_mass=100 ,const Int_t nevt_max = -1){
	...
	histosTH1F["dimuon_multiplicity"] = new TH1F("dimuon_multiplicity", "n dimuons" , 100 , 0 , 100);
        ...
        histosTH1F["dimuon_mass_rp_accept_tsel"] = new TH1F("dimuon_mass_rp_accept_tsel", "mass(mu1,mu2)" , Bin_mass , 0. , 10.);
        histosTH1F["dimuon_pt_rp_accept_tsel"] = new TH1F("dimuon_pt_rp_accept_tsel", "p_{T}(mu1,mu2)" , 100 , 0. , 100.);
        histosTH1F["dimuon_pt2_rp_accept_tsel"] = new TH1F("dimuon_pt2_rp_accept_tsel", "p_{T}2(mu1,mu2)" , 100 , 0. , 1000.);
        histosTH1F["dimuon_eta_rp_accept_tsel"] = new TH1F("dimuon_eta_rp_accept_tsel", "#eta(mu1,mu2)" , 100 , -5.2 , 5.2);
        histosTH1F["dimuon_rapidity_rp_accept_tsel"] = new TH1F("dimuon_rapidity_rp_accept_tsel", "y(mu1,mu2)" , 100 , -15. , 15.);
        //histosTH1F["dimuon_multiplicity_rp_accept_tsel"] = new TH1F("dimuon_multiplicity_rp_accept", "n dimuons" , 100 , 0 , 100);
        histosTH1F["muonDeltaPt_rp_accept_tsel"] = new TH1F("muonDeltaPt_rp_accept_tsel", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
        histosTH1F["muonDeltaEta_rp_accept_tsel"] = new TH1F("muonDeltaEta_rp_accept_tsel", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);	
        histosTH1F["muonDeltaPhi_rp_accept_tsel"] = new TH1F("muonDeltaPhi_rp_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -1.2*M_PI , 1.2*M_PI);
        histosTH1F["muonDphi_rp_accept_tsel"] = new TH1F("muonDphi_rp_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -1.2*M_PI , 1.2*M_PI);
        histosTH1F["muonDeltaY_rp_accept_tsel"] = new TH1F("muonDeltaY_rp_accept_tsel", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
        histosTH1F["dimuon_xi_plus_rp_accept_tsel"]= new TH1F("dimuon_xi_plus_rp_accept_tsel", "#xi^{+}" , 100 , 0.,1.);
        histosTH1F["dimuon_t_plus_rp_accept_tsel"] = new TH1F("dimuon_t_plus_rp_accept_tsel", "|t|^{+}" , 100,0.,5.0);
	...
	//Deltas info TEST
       ...
       //jpsi rp accept && _tsel
        //jpsi mass selection
        histosTH1F["jpsi_mass_rp_accept_tsel"] = new TH1F("jpsi_mass_rp_accept_tsel", "jpsi_mass(mu1,mu2)" , Bin_mass , 0. , 10.);
        histosTH1F["jpsi_pt_rp_accept_tsel"] = new TH1F("jpsi_pt_rp_accept_tsel", "jpsi p_{T}(mu1,mu2)" , 100 , 0. , 20.);
        histosTH1F["jpsi_pt2_rp_accept_tsel"] = new TH1F("jpsi_pt2_rp_accept_tsel", "jpsi p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
        histosTH1F["jpsi_eta_rp_accept_tsel"] = new TH1F("jpsi_eta_rp_accept_tsel", "jpsi #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
        histosTH1F["jpsi_rapidity_rp_accept_tsel"] = new TH1F("jpsi_rapidity_rp_accept_tsel", "jpsi y(mu1,mu2)" , 100 , -15. , 15.);
        histosTH1F["jpsi_multiplicity_rp_accept_tsel"] = new TH1F("jpsi_multiplicity_rp_accept_tsel", "n jpsi(dimuons)" , 100 , 0 , 100);
        histosTH1F["jpsi_xi_plus_rp_accept_tsel"]= new TH1F("jpsi_xi_plus_rp_accept_tsel", "#xi^{+}" , 100 , 0.,1.);
        histosTH1F["jpsi_t_plus_rp_accept_tsel"] = new TH1F("jpsi_t_plus_rp_accept_tsel", "|t|^{+}" , 100,0.,5.0);

        //Deltas info
        histosTH1F["muonDeltaPt_jpsi_rp_accept_tsel"] = new TH1F("muonDeltaPt_jpsi_rp_accept_tsel", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
        histosTH1F["muonDeltaEta_jpsi_rp_accept_tsel"] = new TH1F("muonDeltaEta_jpsi_rp_accept_tsel", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
        histosTH1F["muonDeltaPhi_jpsi_rp_accept_tsel"] = new TH1F("muonDeltaPhi_jpsi_rp_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
        histosTH1F["muonDphi_jpsi_rp_accept_tsel"] = new TH1F("muonDphi_jpsi_rp_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
        histosTH1F["muonDeltaY_jpsi_rp_accept_tsel"] = new TH1F("muonDeltaY_jpsi_rp_accept_tsel", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	...
	//histosTH1F["t_proton_plus_tbin1"] = new TH1F("t_proton_plus_tbin1", "t_proton_plus" , 100, 0., 5.);
	//histosTH1F["t_proton_plus_tbin2"] = new TH1F("t_proton_plus_tbin2", "t_proton_plus" , 100, 0., 5.);
	//histosTH1F["t_proton_plus_tbin3"] = new TH1F("t_proton_plus_tbin3", "t_proton_plus" , 100, 0., 5.);
	//histosTH1F["t_proton_plus_tbin4"] = new TH1F("t_proton_plus_tbin4", "t_proton_plus" , 100, 0., 5.);
	...
	//histosTH1F["thy_proton_plus"] = new TH1F("thy_proton_plus", "thy_proton_plus" , 200, -5e-4, 5e-4);
       ...
       //histosTH1F["t_proton_minus"] = new TH1F("t_proton_minus", "t_proton_minus" ,   20,-1.0,1.0);//11, tbins);
        histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus",  100,0.,5.0);//, 11, tbins);
        histosTH1F["thx_proton_minus"] = new TH1F("thx_proton_minus", "thx_proton_minus" , 100, -5e-4, 5e-4);
        histosTH1F["thy_proton_minus"] = new TH1F("thy_proton_minus", "thy_proton_minus" , 100, -5e-4, 5e-4);
...
//FIXME
histosTH1F["xi_proton_minus_accepted"] = new TH1F("xi_proton_minus_accepted", "xi_proton_minus" ,  100,0.,1.0);// 28, xi_bins);
histosTH1F["xi_proton_plus_accepted"] = new TH1F("xi_proton_plus_accepted", "xi_proton_plus" ,   100,0.,1.0);//28, xi_bins);

/*histosTH1F["xi_proton_plus_accepted_020"] = new TH1F("xi_proton_plus_accepted_020", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_020"] = new TH1F("t_proton_plus_accepted_020", "t_proton_plus" , 100, 0., 5.);
histosTH1F["posx_proton_plus_accepted_020"] = new TH1F("posx_proton_plus_accepted_020", "posx_proton_plus" , 100, -0.05, 0.05);
histosTH1F["posy_proton_plus_accepted_020"] = new TH1F("posy_proton_plus_accepted_020", "posy_proton_plus" , 100, -0.05, 0.05);
histosTH1F["t_proton_plus_accepted_020_tbin1"] = new TH1F("t_proton_plus_accepted_020_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_020_tbin2"] = new TH1F("t_proton_plus_accepted_020_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_020_tbin3"] = new TH1F("t_proton_plus_accepted_020_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_020_tbin4"] = new TH1F("t_proton_plus_accepted_020_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_plus_accepted_021"] = new TH1F("xi_proton_plus_accepted_021", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_021"] = new TH1F("t_proton_plus_accepted_021", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_021_tbin1"] = new TH1F("t_proton_plus_accepted_021_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_021_tbin2"] = new TH1F("t_proton_plus_accepted_021_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_021_tbin3"] = new TH1F("t_proton_plus_accepted_021_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_021_tbin4"] = new TH1F("t_proton_plus_accepted_021_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_plus_accepted_022"] = new TH1F("xi_proton_plus_accepted_022", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_022"] = new TH1F("t_proton_plus_accepted_022", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_022_tbin1"] = new TH1F("t_proton_plus_accepted_022_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_022_tbin2"] = new TH1F("t_proton_plus_accepted_022_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_022_tbin3"] = new TH1F("t_proton_plus_accepted_022_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_022_tbin4"] = new TH1F("t_proton_plus_accepted_022_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_plus_accepted_023"] = new TH1F("xi_proton_plus_accepted_023", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_023"] = new TH1F("t_proton_plus_accepted_023", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_023_tbin1"] = new TH1F("t_proton_plus_accepted_023_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_023_tbin2"] = new TH1F("t_proton_plus_accepted_023_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_023_tbin3"] = new TH1F("t_proton_plus_accepted_023_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_023_tbin4"] = new TH1F("t_proton_plus_accepted_023_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_plus_accepted_024"] = new TH1F("xi_proton_plus_accepted_024", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_024"] = new TH1F("t_proton_plus_accepted_024", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_024_tbin1"] = new TH1F("t_proton_plus_accepted_024_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_024_tbin2"] = new TH1F("t_proton_plus_accepted_024_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_024_tbin3"] = new TH1F("t_proton_plus_accepted_024_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_024_tbin4"] = new TH1F("t_proton_plus_accepted_024_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_plus_accepted_025"] = new TH1F("xi_proton_plus_accepted_025", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_025"] = new TH1F("t_proton_plus_accepted_025", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_025_tbin1"] = new TH1F("t_proton_plus_accepted_025_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_025_tbin2"] = new TH1F("t_proton_plus_accepted_025_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_025_tbin3"] = new TH1F("t_proton_plus_accepted_025_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_025_tbin4"] = new TH1F("t_proton_plus_accepted_025_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_plus_accepted_120"] = new TH1F("xi_proton_plus_accepted_120", "xi_proton_plus" , 100, 0., 1.);
histosTH1F["t_proton_plus_accepted_120"] = new TH1F("t_proton_plus_accepted_120", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_120_tbin1"] = new TH1F("t_proton_plus_accepted_120_tbin1", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_120_tbin2"] = new TH1F("t_proton_plus_accepted_120_tbin2", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_120_tbin3"] = new TH1F("t_proton_plus_accepted_120_tbin3", "t_proton_plus" , 100, 0., 5.);
histosTH1F["t_proton_plus_accepted_120_tbin4"] = new TH1F("t_proton_plus_accepted_120_tbin4", "t_proton_plus" , 100, 0., 5.);

histosTH1F["xi_proton_minus_accepted_120"] = new TH1F("xi_proton_minus_accepted_120", "xi_proton_minus" , 100, 0., 1.);
histosTH1F["t_proton_minus_accepted_120"] = new TH1F("t_proton_minus_accepted_120", "t_proton_minus" , 100, 0., 5.);
histosTH1F["posx_proton_minus_accepted_120"] = new TH1F("posx_proton_minus_accepted_120", "posx_proton_minus" , 100, -0.05, 0.05);
histosTH1F["posy_proton_minus_accepted_120"] = new TH1F("posy_proton_minus_accepted_120", "posy_proton_minus" , 100, -0.05, 0.05);
histosTH1F["t_proton_minus_accepted_120_tbin1"] = new TH1F("t_proton_minus_accepted_120_tbin1", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_120_tbin2"] = new TH1F("t_proton_minus_accepted_120_tbin2", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_120_tbin3"] = new TH1F("t_proton_minus_accepted_120_tbin3", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_120_tbin4"] = new TH1F("t_proton_minus_accepted_120_tbin4", "t_proton_minus" , 100, 0., 5.);

histosTH1F["xi_proton_minus_accepted_121"] = new TH1F("xi_proton_minus_accepted_121", "xi_proton_minus" , 100, 0., 1.);
histosTH1F["t_proton_minus_accepted_121"] = new TH1F("t_proton_minus_accepted_121", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_121_tbin1"] = new TH1F("t_proton_minus_accepted_121_tbin1", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_121_tbin2"] = new TH1F("t_proton_minus_accepted_121_tbin2", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_121_tbin3"] = new TH1F("t_proton_minus_accepted_121_tbin3", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_121_tbin4"] = new TH1F("t_proton_minus_accepted_121_tbin4", "t_proton_minus" , 100, 0., 5.);

histosTH1F["xi_proton_minus_accepted_122"] = new TH1F("xi_proton_minus_accepted_122", "xi_proton_minus" , 100, 0., 1.);
histosTH1F["t_proton_minus_accepted_122"] = new TH1F("t_proton_minus_accepted_122", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_122_tbin1"] = new TH1F("t_proton_minus_accepted_122_tbin1", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_122_tbin2"] = new TH1F("t_proton_minus_accepted_122_tbin2", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_122_tbin3"] = new TH1F("t_proton_minus_accepted_122_tbin3", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_122_tbin4"] = new TH1F("t_proton_minus_accepted_122_tbin4", "t_proton_minus" , 100, 0., 5.);

histosTH1F["xi_proton_minus_accepted_123"] = new TH1F("xi_proton_minus_accepted_123", "xi_proton_minus" , 100, 0., 1.);
histosTH1F["t_proton_minus_accepted_123"] = new TH1F("t_proton_minus_accepted_123", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_123_tbin1"] = new TH1F("t_proton_minus_accepted_123_tbin1", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_123_tbin2"] = new TH1F("t_proton_minus_accepted_123_tbin2", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_123_tbin3"] = new TH1F("t_proton_minus_accepted_123_tbin3", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_123_tbin4"] = new TH1F("t_proton_minus_accepted_123_tbin4", "t_proton_minus" , 100, 0., 5.);

histosTH1F["xi_proton_minus_accepted_124"] = new TH1F("xi_proton_minus_accepted_124", "xi_proton_minus" , 100, 0., 1.);
histosTH1F["t_proton_minus_accepted_124"] = new TH1F("t_proton_minus_accepted_124", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_124_tbin1"] = new TH1F("t_proton_minus_accepted_124_tbin1", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_124_tbin2"] = new TH1F("t_proton_minus_accepted_124_tbin2", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_124_tbin3"] = new TH1F("t_proton_minus_accepted_124_tbin3", "t_proton_minus" , 100, 0., 5.);
histosTH1F["t_proton_minus_accepted_124_tbin4"] = new TH1F("t_proton_minus_accepted_124_tbin4", "t_proton_minus" , 100, 0., 5.);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		bool proton_plus_rp_accept = (( proton_plus_rp_accept_020 && proton_plus_rp_accept_024 ) || ( proton_plus_rp_accept_021 && proton_plus_rp_accept_025 ) ||( proton_plus_rp_accept_022 && proton_plus_rp_accept_023 ) );
                ...
                cout<<"t_proton_plus antes de accept :"<<fabs(t_proton_plus)<<endl;  
		...
		++n_dimuons_rp_selected_plus_side;	
                ...
                //rp_accept &&  |t| selection 
		if (verbose) cout<< " |t| selection  : "<< " | "<< t_proton_down_ << " - " << t_proton_up_<< " |"<< endl;

		if ((fabs(t_proton_plus) > t_proton_down_) && (fabs(t_proton_plus)<t_proton_up_)){
		...
		++n_dimuons_rp_selected_tsel_plus_side;	
                ...
                histosTH1F["dimuon_pt2_rp_accept_tsel"]->Fill(dimuon_pt2, event_weight );
                histosTH1F["dimuon_eta_rp_accept_tsel"]->Fill( dimuon_eta, event_weight );
                histosTH1F["dimuon_rapidity_rp_accept_tsel"]->Fill( dimuon_rapidity, event_weight );
                histosTH1F["muonDeltaPt_rp_accept_tsel"]->Fill(deltapt, event_weight );
                histosTH1F["muonDeltaEta_rp_accept_tsel"]->Fill(deltaeta, event_weight );	
                histosTH1F["muonDphi_rp_accept_tsel"]->Fill(Dphi, event_weight );
                histosTH1F["muonDeltaPhi_rp_accept_tsel"]->Fill(deltaphi, event_weight );
                histosTH1F["muonDeltaY_rp_accept_tsel"]->Fill(deltay, event_weight ); 
                ...
                if(((dimuon_mass > 3.0) && (dimuon_mass < 3.2))){  
                  ...
                  histosTH1F["jpsi_pt2_rp_accept_tsel"]->Fill( jpsi_pt2, event_weight );
                  histosTH1F["jpsi_eta_rp_accept_tsel"]->Fill( jpsi_eta, event_weight );
                  histosTH1F["jpsi_rapidity_rp_accept_tsel"]->Fill( jpsi_rapidity, event_weight );
                  histosTH1F["muonDeltaPt_jpsi_rp_accept_tsel"]->Fill(deltapt, event_weight );
                  histosTH1F["muonDeltaEta_jpsi_rp_accept_tsel"]->Fill(deltaeta, event_weight );	
                  histosTH1F["muonDeltaPhi_jpsi_rp_accept_tsel"]->Fill(deltaphi, event_weight );
                  histosTH1F["muonDeltaY_jpsi_rp_accept_tsel"]->Fill(deltay, event_weight );  
                  cout<<"jpsi_t_plus_rp_accept_tsel"<<fabs(t_proton_plus)<<endl;
                  histosTH1F["jpsi_t_plus_rp_accept_tsel"]->Fill( fabs(t_proton_plus), event_weight );
                  histosTH1F["jpsi_xi_plus_rp_accept_tsel"]->Fill( xi_proton_plus, event_weight );
                  histosTH1F["muonDphi_jpsi_rp_accept_tsel"]->Fill(Dphi, event_weight );
                 }
