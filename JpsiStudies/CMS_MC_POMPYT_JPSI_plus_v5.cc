...
void CMS_MC_POMPYT_JPSI_plus_v5(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.0, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.0,const Double_t xi_proton_up_=0.2,const Int_t Bin_mass=100 ,const Int_t nevt_max = -1){
	...
	//Deltas info TEST
        ...
        histosTH1F["jpsi_xi_plus_rp_accept"]= new TH1F("jpsi_xi_plus_rp_accept", "#xi^{+}" , 30 , 0.,1.);
        histosTH1F["jpsi_t_plus_rp_accept"] = new TH1F("jpsi_t_plus_rp_accept", "|t|^{+}" , 30,0.,5.0);
       ...
       //jpsi rp accept && _tsel
        ...
        histosTH1F["jpsi_xi_plus_rp_accept_tsel"]= new TH1F("jpsi_xi_plus_rp_accept_tsel", "#xi^{+}" , 30 , 0.,1.);
        histosTH1F["jpsi_t_plus_rp_accept_tsel"] = new TH1F("jpsi_t_plus_rp_accept_tsel", "|t|^{+}" , 30,0.,5.0);
