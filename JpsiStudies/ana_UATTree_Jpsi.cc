...
void ana_UATTree_Jpsi(vector<string> const& fileNames, string const& outputFileName = "output.root", const Int_t nevt_max = 100){
  ...
  histosTH1F["track_multiplicity"] = new TH1F("track_multiplicity", "n tracks" , 100 , 0 , 100);
	...
	histosTH1F["muon2_rapidity"] = new TH1F("muon2_rapidity", "y(mu2)" , 100 , -15. , 15.);
        ...
        //Dimuon
	histosTH1F["dimuon_mass"] = new TH1F("dimuon_mass", "mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	//dimuon_proton_right
        ...
        histosTH1F["dimuon_mass_proton_right"] = new TH1F("dimuon_mass_proton_right", "mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	histosTH1F["dimuon_mass_t_cut_proton_right"] = new TH1F("dimuon_mass_t_cut_proton_right", "mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	histosTH1F["dimuon_multiplicity_t_cut_proton_right"] = new TH1F("dimuon_multiplicity_t_cut_proton_right", "n dimuons" , 100 , 0 , 100);
        ...
        /*histosTH1F["dimuon_mass_t_cut_xi_cut_proton_right"] = new TH1F("dimuon_mass_t_cut_xi_cut_proton_right", "mass(mu1,mu2)" , 100 , 0. , 10.);
        ...
        //Muon1 info
        //histosTH1F["muon1_mass"] = new TH1F("muon1_mass", "mass_{#mu 1}" , 100 , 0. , 5.);
        ...
        //Muon1 info
        //histosTH1F["muon2_mass"] = new TH1F("muon2_mass", "mass_{#mu 2}" , 100 , 0. , 5.);
	...
	//dimuon_proton_left
        ...
        histosTH1F["dimuon_mass_proton_left"] = new TH1F("dimuon_mass_proton_left", "mass(mu1,mu2)" , 100 , 0. , 10.);
        ...
        //_t_cut_proton_left
	histosTH1F["dimuon_mass_t_cut_proton_left"] = new TH1F("dimuon_mass_t_cut_proton_left", "mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	histosTH1F["dimuon_multiplicity_t_cut_proton_left"] = new TH1F("dimuon_multiplicity_t_cut_proton_left", "n dimuons" , 100 , 0 , 100);
       ...
       /* histosTH1F["dimuon_mass_t_cut_xi_cut_proton_left"] = new TH1F("dimuon_mass_t_cut_xi_cut_proton_left", "mass(mu1,mu2)" , 100 , 0. , 10.);
        ...
        */
        ...
        //jpsi mass selection
        histosTH1F["jpsi_mass"] = new TH1F("jpsi_mass", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
        ...
        histosTH1F["jpsi_mass_proton_right"] = new TH1F("jpsi_mass_proton_right", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
        ...
        histosTH1F["jpsi_mass_proton_left"] = new TH1F("jpsi_mass_proton_left", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	//_t_cut_proton_right
	histosTH1F["jpsi_dimuon_mass_t_cut_proton_right"] = new TH1F("jpsi_dimuon_mass_t_cut_proton_right", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	histosTH1F["jpsi_dimuon_multiplicity_t_cut_proton_right"] = new TH1F("jpsi_dimuon_multiplicity_t_cut_proton_right", "n dimuons" , 100 , 0 , 20);
       ...
       //t_cut_xi_cut_proton_right
       /* histosTH1F["jpsi_dimuon_mass_t_cut_xi_cut_proton_right"] = new TH1F("jpsi_dimuon_mass_t_cut_xi_cut_proton_right", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	//_t_cut_proton_left
	histosTH1F["jpsi_dimuon_mass_t_cut_proton_left"] = new TH1F("jpsi_dimuon_mass_t_cut_proton_left", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
	...
	histosTH1F["jpsi_dimuon_multiplicity_t_cut_proton_left"] = new TH1F("jpsi_dimuon_multiplicity_t_cut_proton_left", "n jpsi_dimuons" , 100 , 0 , 20);
       ...
       //t_cut_xi_cut_proton_left
        histosTH1F["jpsi_dimuon_mass_t_cut_xi_cut_proton_left"] = new TH1F("jpsi_dimuon_mass_t_cut_xi_cut_proton_left", "jpsi_mass(mu1,mu2)" , 100 , 0. , 10.);
...
//-----------------------------------------------------------------------------------------
	 ...
	 if( good_proton_right ){
		...
		histosTH1F["jpsi_proton_right_xi"]->Fill( xi_proton_right, event_weight );
            ...
            if(verbose) cout<< "dimuon_mass before t sel:"<< dimuon_mass<<endl;
            if(proton_plus_t_range){
	 ...
	 if( good_proton_left ){
		...
		histosTH1F["jpsi_proton_left_xi"]->Fill( xi_proton_left, event_weight );
            ...
            if(verbose) cout<< "dimuon_mass left before t sel:"<< dimuon_mass<<endl;
            if(proton_minus_t_range){
