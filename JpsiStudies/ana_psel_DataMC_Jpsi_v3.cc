...
void ana_psel_DataMC_Jpsi_v3(vector<string> const& fileNames, string const& outputFileName = "output.root",const Double_t t_proton_down_=0.03, const Double_t t_proton_up_=1.0,const Int_t Bin_mass=100 ,const Int_t nevt_max = -1){
...
//==========================================================
	...
	for(int i_evt = 0; i_evt < nev && i_tot < nevt_max_corr; ++i_evt , ++i_tot){
		...
		if(isMC){
			...
			if(sdplus){
				if(proton_pz_plus > 0.){
					...
					//proton_plus_rp_accept_020 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 20, out_x, out_thx, out_y, out_thy, out_xi);
                                        proton_plus_rp_accept_020 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 20, out_x, out_thx, out_y, out_thy, out_xi);
					...
					//proton_plus_rp_accept_021 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 21, out_x, out_thx, out_y, out_thy, out_xi);
                                        proton_plus_rp_accept_021 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 21, out_x, out_thx, out_y, out_thy, out_xi);
					...
					//proton_plus_rp_accept_022 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 22, out_x, out_thx, out_y, out_thy, out_xi);
                                        proton_plus_rp_accept_022 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 22, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_plus_rp_accept_023 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 23, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_plus_rp_accept_024 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 24, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_plus_rp_accept_025 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 25, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_plus_rp_accept_120 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 120);
			...
			if(sdminus){
				if(proton_pz_minus < 0.){ 
					...
					double out_x, out_thx, out_y, out_thy, out_xi;
					proton_minus_rp_accept_120 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 120, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_minus_rp_accept_121 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 121, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_minus_rp_accept_122 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 122, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_minus_rp_accept_123 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 123, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_minus_rp_accept_124 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 124, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_minus_rp_accept_125 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 125, out_x, out_thx, out_y, out_thy, out_xi);
					...
					proton_minus_rp_accept_020 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 20);
		...
		// RP protons
		if(!isMC){
			if(verbose)cout<<"1729-RP_track_info"<<endl;
			...
			bool good_proton_right = proton_right_valid && ((-0.04 < xi_proton_right)&&( xi_proton_right < 0.23));
			...
			bool good_proton_left = proton_left_valid && ((-0.04 < xi_proton_left)&&( xi_proton_left < 0.23));
				...
				if( good_proton_left  && dimuon_pt <= ptMax){
					...
					if( good_proton_right  && dimuon_pt <= ptMax){
						...
						if(isMC){
							...
							histosTH1F["EventSelection"]->Fill( "MCRPMinusAccept", event_weight );
							if(sdplus){
								if( proton_plus_rp_accept  && dimuon_pt <= ptMax){
							...
							if(sdminus){
								if( proton_minus_rp_accept  && dimuon_pt <= ptMax){
