...
void ana_psel_DataJPsi_V3(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.0, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.0,const Double_t xi_proton_up_=0.2,const Int_t Bin_mass=100 ,const Int_t nevt_max = -1){
	...
	histosTH1F["proton_left_chi2"] = new TH1F("proton_left_chi2", "#chi^{2}" , 100 , 0. , 100.);
        ...
        histosTH1F["proton_left_thy"] = new TH1F("thy_proton_left", "thx_proton_left" , 100, -5e-4, 5e-4);
	...
	histosTH1F["x0_proton_left"] = new TH1F("x0_proton_left", "x0_proton_left" , 100, -10., 10.);
        ...
        histosTH1F["proton_right_thy"] = new TH1F("thy_proton_right", "thx_proton_right" , 100, -5e-4, 5e-4);
...
//-----------------------------------------------------------------------------------------
			...
			if( good_proton_right ){
				...
				/*histosTH1F["proton_right_thx"]->Fill(thx_proton_right, event_weight );
				histosTH1F["proton_right_thy"]->Fill(thy_proton_right, event_weight );
			...
			if( good_proton_left ){
				...
				/*histosTH1F["proton_left_thx"]->Fill(thx_proton_left, event_weight );
				histosTH1F["proton_left_thy"]->Fill(thy_proton_left, event_weight );
