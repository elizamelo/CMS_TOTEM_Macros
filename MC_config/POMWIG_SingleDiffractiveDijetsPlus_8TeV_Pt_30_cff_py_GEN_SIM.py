...
# with command line options: GeneratorInterface/PomwigInterface/python/POMWIG_SingleDiffractiveDijetsPlus_8TeV_Pt_30_cff.py --step GEN,SIM --beamspot Realistic8TeVCollision --conditions START52_V9::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN-SIM -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('GeneratorInterface/PomwigInterface/python/POMWIG_SingleDiffractiveDijetsPlus_8TeV_Pt_30_cff.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('POMWIG_SingleDiffractiveDijetsPlus_8TeV_Pt_30_cff_py_GEN_SIM.root'),
