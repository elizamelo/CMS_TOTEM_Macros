...
/*
 */
void CMS_MC_POMWIG_DY_minus(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.003, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.01,const Double_t xi_proton_up_=0.15,const Int_t Bin_mass=200 ,const Int_t nevt_max = -1){
