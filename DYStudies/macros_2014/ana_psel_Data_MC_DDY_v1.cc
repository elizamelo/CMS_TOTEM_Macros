...
void ana_psel_DataMC_DDY_v1(vector<string> const& fileNames, string const& outputFileName = "output.root",const Double_t t_proton_down_=0.03, const Double_t t_proton_up_=1.0, const Double_t low_Bin=10.0,const Double_t high_Bin=20.0,const Int_t Bin_mass=200 ,const Int_t nevt_max = -1){

//const Double_t t_proton_down_=0.0, const Double_t t_proton_up_=1.0,const Int_t Bin_mass=100 ,const Int_t nevt_max = -1){
//const Double_t xi_proton_down_=0.01,const Double_t xi_proton_up_=0.15
	//bool isMC  = true;
       	bool isMC  = false;
	bool verbose = false;
        bool Vertex = false;
	...
	bool sdplus = selectRPPlusAccept;//plus size

	bool sdminus = selectRPMinusAccept;//minus size
	...
	histosTH1F["dimuon_mass_proton_right"] = new TH1F("dimuon_mass_proton_right", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	...
	histosTH1F["dimuon_mass_proton_left"] = new TH1F("dimuon_mass_proton_left", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	...
	//dy mass selection
	histosTH1F["dy_mass"] = new TH1F("dy_mass", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt"] = new TH1F("dy_pt", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2"] = new TH1F("dy_pt2", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta"] = new TH1F("dy_eta", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity"] = new TH1F("dy_rapidity", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	histosTH1F["dy_multiplicity"] = new TH1F("dy_multiplicity", "n dy(dimuons)" , 100 , 0 , 100);

	//Deltas info
	histosTH1F["muonDeltaPt_dy"] = new TH1F("muonDeltaPt_dy", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy"] = new TH1F("muonDeltaEta_dy", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy"] = new TH1F("muonDeltaPhi_dy", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy"] = new TH1F("muonDeltaY_dy", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	//Dimuon
        histosTH1F["lorentzdphi_dy"] = new TH1F("lorentzDPhi_dy", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);

	//proton_right
	histosTH1F["dy_proton_right_xi"] = new TH1F("dy_proton_right_xi", "#xi" ,200, -1., 1.);
	histosTH1F["dy_proton_right_t"] = new TH1F("dy_proton_right_t", "-t" , 100, 0.,5.);
	histosTH1F["dy_mass_proton_right"] = new TH1F("dy_mass_proton_right", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt_proton_right"] = new TH1F("dy_pt_proton_right", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2_proton_right"] = new TH1F("dy_pt2_proton_right", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta_proton_right"] = new TH1F("dy_eta_proton_right", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity_proton_right"] = new TH1F("dy_rapidity_proton_right", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	histosTH1F["dy_multiplicity_proton_right"] = new TH1F("dy_multiplicity_proton_right", "n dy(dimuons)" , 100 , 0 , 100);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_proton_right"] = new TH1F("muonDeltaPt_dy_proton_right", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_proton_right"] = new TH1F("muonDeltaEta_dy_proton_right", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_proton_right"] = new TH1F("muonDeltaPhi_dy_proton_right", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_proton_right"] = new TH1F("muonDeltaY_dy_proton_right", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	//proton_left
	histosTH1F["dy_proton_left_xi"] = new TH1F("dy_proton_left_xi", "#xi" , 200, -1.,1. );
	histosTH1F["dy_proton_left_t"] = new TH1F("dy_proton_left_t", "-t" , 100, 0.,5.);
	histosTH1F["dy_mass_proton_left"] = new TH1F("dy_mass_proton_left", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt_proton_left"] = new TH1F("dy_pt_proton_left", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2_proton_left"] = new TH1F("dy_pt2_proton_left", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta_proton_left"] = new TH1F("dy_eta_proton_left", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity_proton_left"] = new TH1F("dy_rapidity_proton_left", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	histosTH1F["dy_multiplicity_proton_left"] = new TH1F("dy_multiplicity_proton_left", "n dy(dimuons)" , 100 , 0 , 100);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_proton_left"] = new TH1F("muonDeltaPt_dy_proton_left", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_proton_left"] = new TH1F("muonDeltaEta_dy_proton_left", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_proton_left"] = new TH1F("muonDeltaPhi_dy_proton_left", "#Delta#phi(mu1,mu2)" , 100 ,-2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_proton_left"] = new TH1F("muonDeltaY_dy_proton_left", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);        

	//_t_cut_proton_right
	histosTH1F["dy_dimuon_mass_t_cut_proton_right"] = new TH1F("dy_dimuon_mass_t_cut_proton_right", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_dimuon_pt_t_cut_proton_right"] = new TH1F("dy_dimuon_pt_t_cut_proton_right", "p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_dimuon_pt2_t_cut_proton_right"] = new TH1F("dy_dimuon_pt2_t_cut_proton_right", "p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_dimuon_eta_t_cut_proton_right"] = new TH1F("dy_dimuon_eta_t_cut_proton_right", "#eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_dimuon_rapidity_t_cut_proton_right"] = new TH1F("dy_dimuon_rapidity_t_cut_proton_right", "y(mu1,mu2)" , 100 , -15. , 15.);
	histosTH1F["dy_dimuon_multiplicity_t_cut_proton_right"] = new TH1F("dy_dimuon_multiplicity_t_cut_proton_right", "n dimuons" , 100 , 0 , 20);

	histosTH1F["muonDeltaPt_dy_t_cut_proton_right"] = new TH1F("muonDeltaPt_dy_t_cut_proton_right", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_t_cut_proton_right"] = new TH1F("muonDeltaEta_dy_t_cut_proton_right", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_t_cut_proton_right"] = new TH1F("muonDeltaPhi_dy_t_cut_proton_right", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_t_cut_proton_right"] = new TH1F("muonDeltaY_dy_t_cut_proton_right", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	histosTH1F["dy_proton_right_xi_t_cut"] = new TH1F("dy_proton_right_xi_t_selected", "#xi" , 200, -1.,1.);
	histosTH1F["dy_proton_right_t_t_cut"] = new TH1F("dy_proton_right_t_t_selected", "-t" , 100, 0.,5.);
	...
	//_t_cut_proton_left
	histosTH1F["dy_dimuon_mass_t_cut_proton_left"] = new TH1F("dy_dimuon_mass_t_cut_proton_left", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_dimuon_pt_t_cut_proton_left"] = new TH1F("dy_dimuon_pt_t_cut_proton_left", "p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_dimuon_pt2_t_cut_proton_left"] = new TH1F("dy_dimuon_pt2_t_cut_proton_left", "p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_dimuon_eta_t_cut_proton_left"] = new TH1F("dy_dimuon_eta_t_cut_proton_left", "#eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_dimuon_rapidity_t_cut_proton_left"] = new TH1F("dy_dimuon_rapidity_t_cut_proton_left", "y(mu1,mu2)" , 100 , -15. , 15.);
	histosTH1F["dy_dimuon_multiplicity_t_cut_proton_left"] = new TH1F("dy_dimuon_multiplicity_t_cut_proton_left", "n dy_dimuons" , 100 , 0 , 20);

	histosTH1F["dy_proton_left_xi_t_cut"] = new TH1F("dy_proton_left_xi_t_selected", "#xi" ,200, -1.,1. );
	histosTH1F["dy_proton_left_t_t_cut"] = new TH1F("dy_proton_left_t_t_selected", "-t" , 100, 0., 5.);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_t_cut_proton_left"] = new TH1F("muonDeltaPt_dy_t_cut_proton_left", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_t_cut_proton_left"] = new TH1F("muonDeltaEta_dy_t_cut_proton_left", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_t_cut_proton_left"] = new TH1F("muonDeltaPhi_dy_t_cut_proton_left", "#Delta#phi(mu1,mu2)" , 100 ,-2.2*M_PI ,2.2*M_PI);
	histosTH1F["muonDeltaY_dy_t_cut_proton_left"] = new TH1F("muonDeltaY_dy_t_cut_proton_left", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	//t_cut_xi_cut_proton_left
	histosTH1F["dy_dimuon_mass_t_cut_xi_cut_proton_left"] = new TH1F("dy_dimuon_mass_t_cut_xi_cut_proton_left", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_dimuon_pt_t_cut_xi_cut_proton_left"] = new TH1F("dy_dimuon_pt_t_cut_xi_cut_proton_left", "p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_dimuon_pt2_t_cut_xi_cut_proton_left"] = new TH1F("dy_dimuon_pt2_t_cut_xi_cut_proton_left", "p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_dimuon_eta_t_cut_xi_cut_proton_left"] = new TH1F("dy_dimuon_eta_t_cut_xi_cut_proton_left", "#eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_dimuon_rapidity_t_cut_xi_cut_proton_left"] = new TH1F("dy_dimuon_rapidity_t_cut_xi_cut_proton_left", "y(mu1,mu2)" , 100 , -15. , 15.);
	histosTH1F["dy_dimuon_multiplicity_t_cut_xi_cut_proton_left"] = new TH1F("dy_dimuon_multiplicity_t_cut_xi_cut_proton_left", "n dy_dimuons" , 100 , 0 , 20);
	histosTH1F["dy_proton_left_xi_t_cut_xi_cut"] = new TH1F("dy_proton_left_xi_selected_t_and_xi ", "#xi" , 30, -1.,1. );
	histosTH1F["dy_proton_left_t_t_cut_xi_cut"] = new TH1F("dy_proton_left_t_selected_t_and_xi", "-t" ,  30, 0., 5.);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_t_cut_xi_cut_proton_left"] = new TH1F("muonDeltaPt_dy_t_cut_xi_cut_proton_left", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_t_cut_xi_cut_proton_left"] = new TH1F("muonDeltaEta_dy_t_cut_xi_cut_proton_left", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_t_cut_xi_cut_proton_left"] = new TH1F("muonDeltaPhi_dy_t_cut_xi_cut_proton_left", "#Delta#phi(mu1,mu2)" , 100 ,-2.2*M_PI ,2.2*M_PI);
	histosTH1F["muonDeltaY_dy_t_cut_xi_cut_proton_left"] = new TH1F("muonDeltaY_dy_t_cut_xi_cut_proton_left", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	//

	histosTH2F["DeltaPhi_vs_dimuon_pt"] = new TH2F("DeltaPhi_vs_dimuon_pt", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );

	histosTH2F["dy_DeltaPhi_vs_dimuon_pt"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );
	...
	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_proton_right"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_proton_right", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI ); 

	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_t_cut_proton_right"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_t_cut_proton_right", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );

	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_proton_left"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_proton_left", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI ); 

	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_t_cut_proton_left"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_t_cut_proton_left", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );
	...
	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpplus_accept"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_rpplus_accept", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );
	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpplus_accept_tsel"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_rpplus_accept_tsel", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );

	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpminus_accept"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_rpminus_accept", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );
	histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpminus_accept_tsel"] = new TH2F("dy_DeltaPhi_vs_dimuon_pt_rpminus_accept_tsel", "#Delta#phi_vs_dimuon_p_{T}" , 100, 0.0, 20.0, 100, 0.0,1.2*M_PI );
	...
	//histosTH1F["pf_EMinusPz"] = new TH1F("pf_EMinusPz","sum(E - pz)",200 , -1.,1.);
        histosTH1F["random_xi_cms_plus"] = new TH1F("random_xi_cms_plus", "#xi^{+} CMS" , 200 , -1.,1.);
        histosTH1F["random_xi_cms_minus"] = new TH1F("random_xi_cms_minus", "#xi^{-} CMS" , 200 , -1.,1.);
        histosTH1F["random_xi_totem_right"] = new TH1F("random_xi_totem_right","#xi TOTEM",200,-1.,1.);
        histosTH1F["random_xi_totem_left"] = new TH1F("random_xi_totem_left","#xi TOTEM",200,-1.,1.);
	...
	histosTH1F["rp_track_posy_125"] = new TH1F("rp_track_posy_125", "y(RP track)" , 500, -50., 50.);
        ...
        histosTH2F["proton_left_xi_vs_rp_track_posx_020"] =  new TH2F("proton_left_xi_vs_rp_track_posx_020","#x_vs_xi left",  200, -10., 10.,250,-0.3,0.04); 
        histosTH2F["proton_left_xi_vs_rp_track_posx_021"] =  new TH2F("proton_left_xi_vs_rp_track_posx_021","#x_vs_xi left",  200, -10., 10.,250,-0.3,0.04); 
        histosTH2F["proton_left_xi_vs_rp_track_posx_022"] =  new TH2F("proton_left_xi_vs_rp_track_posx_022","#x_vs_xi left",  200, -10., 10.,250,-0.3,0.04);         
        histosTH2F["proton_left_xi_vs_rp_track_posx_023"] =  new TH2F("proton_left_xi_vs_rp_track_posx_023","#x_vs_xi left",  200, -10., 10.,250,-0.3,0.04);   
        histosTH2F["proton_left_xi_vs_rp_track_posx_024"] =  new TH2F("proton_left_xi_vs_rp_track_posx_024","#x_vs_xi left",  200, -10., 10.,250,-0.3,0.04);
        histosTH2F["proton_left_xi_vs_rp_track_posx_025"] =  new TH2F("proton_left_xi_vs_rp_track_posx_025","#x_vs_xi left",  200, -10., 10.,250,-0.3,0.04); 

        histosTH2F["proton_right_xi_vs_rp_track_posx_120"] =  new TH2F("proton_right_xi_vs_rp_track_posx_120","#x_vs_xi rigth",  200, -10., 10.,250,-0.3,0.04); 
        histosTH2F["proton_right_xi_vs_rp_track_posx_121"] =  new TH2F("proton_right_xi_vs_rp_track_posx_121","#x_vs_xi rigth",  200, -10., 10.,250,-0.3,0.04);   
        histosTH2F["proton_right_xi_vs_rp_track_posx_122"] =  new TH2F("proton_right_xi_vs_rp_track_posx_122","#x_vs_xi rigth",  200, -10., 10.,250,-0.3,0.04);   
        histosTH2F["proton_right_xi_vs_rp_track_posx_123"] =  new TH2F("proton_right_xi_vs_rp_track_posx_123","#x_vs_xi rigth",  200, -10., 10.,250,-0.3,0.04);   
        histosTH2F["proton_right_xi_vs_rp_track_posx_124"] =  new TH2F("proton_right_xi_vs_rp_track_posx_124","#x_vs_xi rigth",  200, -10., 10.,250,-0.3,0.04);
        histosTH2F["proton_right_xi_vs_rp_track_posx_125"] =  new TH2F("proton_right_xi_vs_rp_track_posx_125","#x_vs_xi rigth",  200, -10., 10.,250,-0.3,0.04);
	...
	histosTH2F["proton_plus_xi_vs_t"] = new TH2F("proton_plus_xi_vs_t","proton_plus_xi_vs_t", 200, 0., 5., 200, -1., 1.);
	histosTH2F["proton_minus_xi_vs_t"] = new TH2F("proton_minus_xi_vs_t","proton_minus_xi_vs_t", 200, 0., 5., 200, -1., 1.);

	histosTH2F["proton_plus_xi_vs_t_accepted"] = new TH2F("proton_plus_xi_vs_t_accepted","proton_plus_xi_vs_t", 200, 0., 5., 200, -1., 1.);
	histosTH2F["proton_minus_xi_vs_t_accepted"] = new TH2F("proton_minus_xi_vs_t_accepted","proton_minus_xi_vs_t", 200, 0., 5., 200, -1., 1.);

	histosTH2F["proton_plus_xi_vs_t_selected"] = new TH2F("proton_plus_xi_vs_t_selected","proton_plus_xi_vs_t", 200, 0., 5., 200, -1., 1.);
	histosTH2F["proton_minus_xi_vs_t_selected"] = new TH2F("proton_minus_xi_vs_t_selected","proton_minus_xi_vs_t", 200, 0., 5., 200, -1., 1.);
	...
	histosTH1F["dimuon_mass_rpplus_accept"] = new TH1F("dimuon_mass_rpplus_accept", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	...
	histosTH1F["dimuon_mass_rpplus_accept_tsel"] = new TH1F("dimuon_mass_rpplus_accept_tsel", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	...
	//dy mass selection
	histosTH1F["dy_mass_rpplus_accept"] = new TH1F("dy_mass_rpplus_accept", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt_rpplus_accept"] = new TH1F("dy_pt_rpplus_accept", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2_rpplus_accept"] = new TH1F("dy_pt2_rpplus_accept", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta_rpplus_accept"] = new TH1F("dy_eta_rpplus_accept", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity_rpplus_accept"] = new TH1F("dy_rapidity_rpplus_accept", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	//histosTH1F["dy_multiplicity_rpplus_accept"] = new TH1F("dy_multiplicity_rp_accept", "n dy(dimuons)" , 100 , 0 , 100);
	histosTH1F["dy_xi_plus_rpplus_accept"]= new TH1F("dy_xi_plus_rpplus_accept", "#xi^{+}" , 200 , -1.,1.);
	histosTH1F["dy_t_plus_rpplus_accept"] = new TH1F("dy_t_plus_rpplus_accept", "|t|^{+}" , 100,0.,5.0);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_rpplus_accept"] = new TH1F("muonDeltaPt_dy_rpplus_accept", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_rpplus_accept"] = new TH1F("muonDeltaEta_dy_rpplus_accept", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_rpplus_accept"] = new TH1F("muonDeltaPhi_dy_rpplus_accept", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDphi_dy_rpplus_accept"] = new TH1F("muonDphi_dy_rpplus_accept", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_rpplus_accept"] = new TH1F("muonDeltaY_dy_rpplus_accept", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	//dy rp accept && _tsel
	//dy mass selection
	histosTH1F["dy_mass_rpplus_accept_tsel"] = new TH1F("dy_mass_rpplus_accept_tsel", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt_rpplus_accept_tsel"] = new TH1F("dy_pt_rpplus_accept_tsel", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2_rpplus_accept_tsel"] = new TH1F("dy_pt2_rpplus_accept_tsel", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta_rpplus_accept_tsel"] = new TH1F("dy_eta_rpplus_accept_tsel", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity_rpplus_accept_tsel"] = new TH1F("dy_rapidity_rpplus_accept_tsel", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	//histosTH1F["dy_multiplicity_rp_accept_tsel"] = new TH1F("dy_multiplicity_rp_accept_tsel", "n dy(dimuons)" , 100 , 0 , 100);
	histosTH1F["dy_xi_plus_rpplus_accept_tsel"]= new TH1F("dy_xi_plus_rpplus_accept_tsel", "#xi^{+}" ,200 , -1.,1.);
	histosTH1F["dy_t_plus_rpplus_accept_tsel"] = new TH1F("dy_t_plus_rpplus_accept_tsel", "|t|^{+}" , 100,0.,5.0);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_rpplus_accept_tsel"] = new TH1F("muonDeltaPt_dy_rpplus_accept_tsel", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_rpplus_accept_tsel"] = new TH1F("muonDeltaEta_dy_rpplus_accept_tsel", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_rpplus_accept_tsel"] = new TH1F("muonDeltaPhi_dy_rpplus_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDphi_dy_rpplus_accept_tsel"] = new TH1F("muonDphi_dy_rpplus_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_rpplus_accept_tsel"] = new TH1F("muonDeltaY_dy_rpplus_accept_tsel", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	//Minus
	// Reco Muons rp_accept
	histosTH1F["dimuon_mass_rpminus_accept"] = new TH1F("dimuon_mass_rpminus_accept", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	...
	// Reco Muons rp_accept && _tsel
	histosTH1F["dimuon_mass_rpminus_accept_tsel"] = new TH1F("dimuon_mass_rpminus_accept_tsel", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	...
	//dy mass selection
	histosTH1F["dy_mass_rpminus_accept"] = new TH1F("dy_mass_rpminus_accept", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt_rpminus_accept"] = new TH1F("dy_pt_rpminus_accept", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2_rpminus_accept"] = new TH1F("dy_pt2_rpminus_accept", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta_rpminus_accept"] = new TH1F("dy_eta_rpminus_accept", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity_rpminus_accept"] = new TH1F("dy_rapidity_rpminus_accept", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	//histosTH1F["dy_multiplicity_rpplus_accept"] = new TH1F("dy_multiplicity_rp_accept", "n dy(dimuons)" , 100 , 0 , 100);
	histosTH1F["dy_xi_minus_rpminus_accept"]= new TH1F("dy_xi_minus_rpminus_accept", "#xi^{+}" , 200 , -1.,1.);
	histosTH1F["dy_t_minus_rpminus_accept"] = new TH1F("dy_t_minus_rpminus_accept", "|t|^{+}" , 100,0.,5.0);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_rpminus_accept"] = new TH1F("muonDeltaPt_dy_rpminus_accept", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_rpminus_accept"] = new TH1F("muonDeltaEta_dy_rpminus_accept", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_rpminus_accept"] = new TH1F("muonDeltaPhi_dy_rpminus_accept", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDphi_dy_rpminus_accept"] = new TH1F("muonDphi_dy_rpminus_accept", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_rpminus_accept"] = new TH1F("muonDeltaY_dy_rpminus_accept", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	//dy rp accept && _tsel
	//dy mass selection
	histosTH1F["dy_mass_rpminus_accept_tsel"] = new TH1F("dy_mass_rpminus_accept_tsel", "dy_mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dy_pt_rpminus_accept_tsel"] = new TH1F("dy_pt_rpminus_accept_tsel", "dy p_{T}(mu1,mu2)" , 100 , 0. , 20.);
	histosTH1F["dy_pt2_rpminus_accept_tsel"] = new TH1F("dy_pt2_rpminus_accept_tsel", "dy p_{T}^{2}(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dy_eta_rpminus_accept_tsel"] = new TH1F("dy_eta_rpminus_accept_tsel", "dy #eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dy_rapidity_rpminus_accept_tsel"] = new TH1F("dy_rapidity_rpminus_accept_tsel", "dy y(mu1,mu2)" , 100 , -15. , 15.);
	//histosTH1F["dy_multiplicity_rp_accept_tsel"] = new TH1F("dy_multiplicity_rp_accept_tsel", "n dy(dimuons)" , 100 , 0 , 100);
	histosTH1F["dy_xi_minus_rpminus_accept_tsel"]= new TH1F("dy_xi_minus_rpminus_accept_tsel", "#xi^{+}" , 200 , -1.,1.);
	histosTH1F["dy_t_minus_rpminus_accept_tsel"] = new TH1F("dy_t_minus_rpminus_accept_tsel", "|t|^{+}" , 100,0.,5.0);

	//Deltas info
	histosTH1F["muonDeltaPt_dy_rpminus_accept_tsel"] = new TH1F("muonDeltaPt_dy_rpminus_accept_tsel", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_dy_rpminus_accept_tsel"] = new TH1F("muonDeltaEta_dy_rpminus_accept_tsel", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["muonDeltaPhi_dy_rpminus_accept_tsel"] = new TH1F("muonDeltaPhi_dy_rpminus_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDphi_dy_rpminus_accept_tsel"] = new TH1F("muonDphi_dy_rpminus_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2.2*M_PI , 2.2*M_PI);
	histosTH1F["muonDeltaY_dy_rpminus_accept_tsel"] = new TH1F("muonDeltaY_dy_rpminus_accept_tsel", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	//============
	...
	int n_dy_selected = 0;
	int n_dy_t_selected_proton_left = 0;
	//int n_dy_t_at_xi_selected_proton_left = 0;
	int n_dy_t_selected_proton_right = 0;
	//int n_dy_t_at_xi_selected_proton_right = 0;
	int n_dy_proton_left = 0;
	int n_dy_proton_right=0;
	...
	int n_dy_selected_rp_accept_plus_side = 0;
	int n_dy_selected_rp_accept_tsel_plus_side = 0;
	int n_dy_selected_rp_accept_minus_side = 0;
	int n_dy_selected_rp_accept_tsel_minus_side = 0;
        int nprotons = 0;
	...
	for(int i_evt = 0; i_evt < nev && i_tot < nevt_max_corr; ++i_evt , ++i_tot){
		...
		double dimuon_rapidity = 0.; double dy_mass = 0.; double dy_pt=0.;
		double dy_pt2=0.; double dy_eta =0.; double dy_rapidity = 0.; //double dphidy = 0.;
		// Muons
		...
		for(vector<MyMuon>::iterator it_muon = muon_coll->begin() ; it_muon != muon_coll->end() ; ++it_muon){
			...
			bool muon_id = it_muon->TMOneStationAngTight &&
				...
				muon_innerTrack.vtxdz[prim_vtx_id] < 30.;
                     ...
                     //   bool pT_cut = it_muon->Pt()>3.0;//GeV
		...
		for(vector<MyMuon>::iterator it_mu1 = muons_selected.begin() ;
			...
			for(vector<MyMuon>::iterator it_mu2 = muons_selected.begin() ;
				...
				// pT Dimuons selection
                               // bool dimuons_pt_cut = dimuon_pt >= 1.5;// GeV
                                //if( !dimuons_pt_cut ) continue;
				...
				//histosTH1F["muonDphi"]->Fill(Dphi, event_weight );
                                //histosTH1F["lorentzdphi"]->Fill(dphidy, event_weight );
				//cout<<"mass_dimuon = "<< dimuon_lorentz.M() << endl;
				////////////////////////////////////////////////////////////////////////////////////////////
				//double Jpsi_mass = dimuon_lorentz.M();
				//cout<<"dy_mass_dimuon = "<< Jpsi_mass << endl;                              
				if(((dimuon_mass > low_Bin) && (dimuon_mass < high_Bin))){
					//cout<<"dy_mass = "<< dimuon_mass << endl;
					++n_dy_selected;
					//double Dphi_dy = std::fabs(deltaPhi(phimu1 ,phimu2));
					//histosTH1F["dy_multiplicity"]->Fill(n_dimuons_selected, event_weight );
					histosTH1F["dy_mass"]->Fill( dimuon_lorentz.M(), event_weight );
					histosTH1F["dy_pt"]->Fill( dimuon_lorentz.Pt(), event_weight );
					histosTH1F["dy_pt2"]->Fill( (dimuon_lorentz.Pt()*dimuon_lorentz.Pt()), event_weight );
					histosTH1F["dy_eta"]->Fill( dimuon_lorentz.Eta(), event_weight );
					histosTH1F["dy_rapidity"]->Fill( dimuon_lorentz.Rapidity(), event_weight );
					histosTH1F["muonDeltaPt_dy"]->Fill(deltapt, event_weight );
					histosTH1F["muonDeltaEta_dy"]->Fill(deltaeta, event_weight );	
					histosTH1F["muonDeltaPhi_dy"]->Fill(deltaphi, event_weight );
					//histosTH1F["muonDphi_dy"]->Fill(Dphi, event_weight );
                                        //histosTH1F["lorentzdphi_dy"]->Fill(dphidy, event_weight );
					histosTH1F["muonDeltaY_dy"]->Fill(deltay, event_weight ); 
					histosTH2F["dy_DeltaPhi_vs_dimuon_pt"]->Fill(dimuon_pt,deltaphi, event_weight );
					dy_mass = dimuon_lorentz.M();  
					dy_pt=dimuon_lorentz.Pt(); 
					dy_pt2=dimuon_lorentz.Pt()*dimuon_lorentz.Pt(); 
					dy_eta =dimuon_lorentz.Eta();
					dy_rapidity = dimuon_lorentz.Rapidity();
					//cout<<"finalizando dy mass cut"<<endl; 
				}   
      ...
      // Particle-flow
		...
		double pfXiMinusReco = xiCorrFactor*pfEMinusPz/8000.;
                ...
                double xi_cms_plus = histosTH1F["xi_cms_pfplus"]->GetRandom(); 
                histosTH1F["random_xi_cms_plus"]->Fill(xi_cms_plus,event_weight); 

                histosTH1F["xi_cms_pfminus"]->Fill(pfXiMinusReco,event_weight);
                double xi_cms_minus = histosTH1F["xi_cms_pfminus"]->GetRandom(); 
                histosTH1F["random_xi_cms_minus"]->Fill(xi_cms_minus,event_weight); 
		...
		//=============================================================================
		if(!isMC){
			if(verbose)cout<<"1697- before to select the proton"<<endl;
		...
		// RP protons
		//if(!isMC){
			if(verbose)cout<<"1876-RP_track_info"<<endl;
			...
			//bool good_proton_right = proton_right_valid && ((-0.23 < xi_proton_right)&&( xi_proton_right < 0.04));   ; //&& ((-0.04 < xi_proton_right)&&( xi_proton_right < 0.23));
			bool good_proton_right = proton_right_valid;
			bool select_proton_minus = false;
                    
                        
			if( good_proton_right ){
				if(verbose)cout<<"2033-good proton rigth"<<endl;
				//double t_proton_right = rec_proton_right->t;
				...
				histosTH1F["proton_right_t"]->Fill( -t_proton_right, event_weight );
                                //histosTH2F["proton_right_xi_vs_rp_track_posx_124"]->Fill( rp_track_posx_124, xi_proton_right, event_weight );
				...
				//histosTH1F["pf_xiMinus_minus_proton_right_xi"]->Fill( (pfXiMinusReco - xi_proton_right), event_weight );
                                if(pfXiMinusReco>0.12){
                                  xi_totem_right_cut = -xi_proton_right;
                                  histosTH1F["proton_right_xi_totem"]->Fill( xi_totem_right_cut, event_weight );
                                  histosTH1F["pf_xiMinus_minus_proton_right_xi"]->Fill( (pfXiMinusReco + xi_proton_right), event_weight );
                                 }
                                histosTH1F["pfxiMinus_minus_proton_right_xi"]->Fill( (pfXiMinusReco + xi_proton_right), event_weight );
                                //double xi_totem_right = histosTH1F["proton_right_xi_totem"]->GetRandom(); 
                                //histosTH1F["random_xi_totem_right"]->Fill(xi_totem_right,event_weight);
                                //histosTH1F["random_pfxiMinus_minus_proton_right_xi"]->Fill( (xi_cms_minus - xi_totem_right), event_weight );
			...
			//bool good_proton_left = proton_left_valid && ((-0.23 < xi_proton_left)&&( xi_proton_left < 0.04));
			bool good_proton_left = proton_left_valid;
			bool select_proton_plus = false;
                        double xi_totem_left_cut;
			if( good_proton_left ){
				...
				histosTH1F["proton_left_t"]->Fill( -t_proton_left, event_weight );
                                //histosTH2F["proton_left_xi_vs_rp_track_posx_024"]->Fill( rp_track_posx_024, xi_proton_left, event_weight );
				...
				/*if(xi_proton_left > 0.){
                                        if(verbose)cout<<"2113-xi_proton_left > 0."<<endl;
				...
				//histosTH1F["pf_xiPlus_minus_proton_left_xi"]->Fill( (pfXiPlusReco + xi_proton_left), event_weight );
                                if (pfXiPlusReco>0.12){
                                  if(verbose)cout<<"2127-pfXiPlusReco>0.11"<<endl;
                                  xi_totem_left_cut = -xi_proton_left;
                                  histosTH1F["proton_left_xi_totem"]->Fill(xi_totem_left_cut, event_weight );
                                  histosTH1F["pf_xiPlus_minus_proton_left_xi"]->Fill( (pfXiPlusReco + xi_proton_left), event_weight );
                                 }
                                histosTH1F["pfxiPlus_minus_proton_left_xi"]->Fill( (pfXiPlusReco + xi_proton_left), event_weight );
                                //double xi_totem_left = histosTH1F["proton_left_xi_totem"]->GetRandom(); 
                                //histosTH1F["random_xi_totem_left"]->Fill(xi_totem_left,event_weight);
                                //histosTH1F["random_pfxiPlus_minus_proton_left_xi"]->Fill( (xi_cms_plus - xi_totem_left), event_weight );

                                //if(verbose)cout<<"(pfXiPlusReco - xi_proton_left) = "<< (pfXiPlusReco - xi_proton_left)<<endl;
				if( (pfXiPlusReco + xi_proton_left) < 0. ){
				  //select_proton_plus = true;
                                  ++nevtxisignalleft;
                                  if(verbose)cout<<"2132 - (pfXiPlusReco - xi_proton_left) < 0.  "<<endl;
				...
				if( good_proton_left  && dimuon_pt <= ptMax){
					...
					if( good_proton_right  && dimuon_pt <= ptMax){
						if((dimuon_mass >low_Bin) && (dimuon_mass < high_Bin)){
							...
							n_dy_proton_right++;
							//double t_proton_right = rec_proton_right->t;
							histosTH1F["dy_proton_right_xi"]->Fill( xi_proton_right, event_weight );
							histosTH1F["dy_proton_right_t"]->Fill( fabs(t_proton_right), event_weight );

							//histosTH1F["dy_multiplicity_proton_right"]->Fill(n_dimuons_selected, event_weight );
							histosTH1F["dy_mass_proton_right"]->Fill( dimuon_mass, event_weight );
							histosTH1F["dy_pt_proton_right"]->Fill( dimuon_pt, event_weight );
							histosTH1F["dy_pt2_proton_right"]->Fill( dimuon_pt2, event_weight );
							histosTH1F["dy_eta_proton_right"]->Fill( dimuon_eta, event_weight );
							histosTH1F["dy_rapidity_proton_right"]->Fill( dimuon_rapidity, event_weight );
							histosTH1F["muonDeltaPt_dy_proton_right"]->Fill(deltapt, event_weight );
							histosTH1F["muonDeltaEta_dy_proton_right"]->Fill(deltaeta, event_weight );
							histosTH1F["muonDeltaPhi_dy_proton_right"]->Fill(deltaphi, event_weight );
							histosTH1F["muonDeltaY_dy_proton_right"]->Fill(deltay, event_weight );
							histosTH2F["dy_DeltaPhi_vs_dimuon_pt_proton_right"]->Fill(dimuon_pt,deltaphi, event_weight );

							if (fabs(t_proton_right)>=t_proton_down_ && fabs(t_proton_right)<t_proton_up_){
								//if(proton_plus_t_range){
								n_dy_t_selected_proton_right++;
								if(verbose) cout<< "t proton right side (abs):"<< "["<< fabs(t_proton_right)<< "]"<< endl;
								outstring_right << evtId->Run << ":"<< evtId->LumiSect << ":"<< evtId->Evt << endl;

								histosTH1F["dy_dimuon_mass_t_cut_proton_right"]->Fill( dimuon_mass, event_weight );
								histosTH1F["dy_dimuon_pt_t_cut_proton_right"]->Fill( dimuon_pt, event_weight );
								histosTH1F["dy_dimuon_pt2_t_cut_proton_right"]->Fill( dimuon_pt2, event_weight );
								histosTH1F["dy_dimuon_eta_t_cut_proton_right"]->Fill( dimuon_eta, event_weight );
								histosTH1F["dy_dimuon_rapidity_t_cut_proton_right"]->Fill( dimuon_rapidity, event_weight );
								histosTH1F["dy_proton_right_xi_t_cut"]->Fill( xi_proton_right, event_weight );
								histosTH1F["dy_proton_right_t_t_cut"]->Fill( fabs(t_proton_right), event_weight );
								histosTH1F["muonDeltaPt_dy_t_cut_proton_right"]->Fill(deltapt, event_weight );
								histosTH1F["muonDeltaEta_dy_t_cut_proton_right"]->Fill(deltaeta, event_weight );
								histosTH1F["muonDeltaPhi_dy_t_cut_proton_right"]->Fill(deltaphi, event_weight );
								histosTH1F["muonDeltaY_dy_t_cut_proton_right"]->Fill(deltay, event_weight );
								histosTH2F["dy_DeltaPhi_vs_dimuon_pt_t_cut_proton_right"]->Fill(dimuon_pt,deltaphi, event_weight );
						...
						if( good_proton_left  && dimuon_pt <= ptMax){
							if((dimuon_mass > low_Bin) && (dimuon_mass < high_Bin)){
								...
								histosTH1F["dy_proton_left_xi"]->Fill(xi_proton_left, event_weight );
								histosTH1F["dy_proton_left_t"]->Fill( fabs(t_proton_left), event_weight );

								histosTH1F["dy_mass_proton_left"]->Fill( dimuon_mass, event_weight );
								histosTH1F["dy_pt_proton_left"]->Fill( dimuon_pt, event_weight );
								histosTH1F["dy_pt2_proton_left"]->Fill( dimuon_pt2, event_weight );
								histosTH1F["dy_eta_proton_left"]->Fill( dimuon_eta, event_weight );
								histosTH1F["dy_rapidity_proton_left"]->Fill( dimuon_rapidity, event_weight );
								histosTH1F["muonDeltaPt_dy_proton_left"]->Fill(deltapt, event_weight );
								histosTH1F["muonDeltaEta_dy_proton_left"]->Fill(deltaeta, event_weight );
								histosTH1F["muonDeltaPhi_dy_proton_left"]->Fill(deltaphi, event_weight );
								histosTH1F["muonDeltaY_dy_proton_left"]->Fill(deltay, event_weight );   

								histosTH2F["dy_DeltaPhi_vs_dimuon_pt_proton_left"]->Fill(dimuon_pt, deltaphi, event_weight );                    			

								if (fabs(t_proton_left)>=t_proton_down_ && fabs(t_proton_left)<t_proton_up_){
									//if(proton_minus_t_range){
									n_dy_t_selected_proton_left++;
									outstring_left << evtId->Run << ":"<< evtId->LumiSect << ":"<< evtId->Evt << endl;

									if(verbose) cout<< "t proton left side (abs):"<< "["<< fabs(t_proton_left)<< "]"<< endl;


									histosTH1F["dy_dimuon_mass_t_cut_proton_left"]->Fill( dimuon_mass, event_weight );
									histosTH1F["dy_dimuon_pt_t_cut_proton_left"]->Fill( dimuon_pt, event_weight );
									histosTH1F["dy_dimuon_pt2_t_cut_proton_left"]->Fill( dimuon_pt2, event_weight );
									histosTH1F["dy_dimuon_eta_t_cut_proton_left"]->Fill( dimuon_eta, event_weight );
									histosTH1F["dy_dimuon_rapidity_t_cut_proton_left"]->Fill( dimuon_rapidity, event_weight );
									histosTH1F["dy_proton_left_xi_t_cut"]->Fill( xi_proton_left, event_weight );
									histosTH1F["dy_proton_left_t_t_cut"]->Fill( fabs(t_proton_left), event_weight );

									histosTH1F["muonDeltaPt_dy_t_cut_proton_left"]->Fill(deltapt, event_weight );
									histosTH1F["muonDeltaEta_dy_t_cut_proton_left"]->Fill(deltaeta, event_weight );
									histosTH1F["muonDeltaPhi_dy_t_cut_proton_left"]->Fill(deltaphi, event_weight );
									histosTH1F["muonDeltaY_dy_t_cut_proton_left"]->Fill(deltay, event_weight );

									histosTH2F["dy_DeltaPhi_vs_dimuon_pt_t_cut_proton_left"]->Fill(dimuon_pt,deltaphi, event_weight );
							...
							if(sdplus){
								if( proton_plus_rp_accept  && dimuon_pt <= ptMax ){//&& xi_proton_plus < 0.23){
									...
									if(((dimuon_mass > low_Bin) && (dimuon_mass < high_Bin))){  
										...
										// cout<<"dy_mass = "<< dy_mass << endl;
										//++n_dy_rp_accept_selected;
										++n_dy_selected_rp_accept_plus_side;
										//histosTH1F["dy_multiplicity_rp_accept"]->Fill(n_dimuons_selected, event_weight );
										histosTH1F["dy_mass_rpplus_accept"]->Fill(dy_mass, event_weight );
										histosTH1F["dy_pt_rpplus_accept"]->Fill( dy_pt, event_weight );
										histosTH1F["dy_pt2_rpplus_accept"]->Fill( dy_pt2, event_weight );
										histosTH1F["dy_eta_rpplus_accept"]->Fill( dy_eta, event_weight );
										histosTH1F["dy_rapidity_rpplus_accept"]->Fill( dy_rapidity, event_weight );
										histosTH1F["muonDeltaPt_dy_rpplus_accept"]->Fill(deltapt, event_weight );
										histosTH1F["muonDeltaEta_dy_rpplus_accept"]->Fill(deltaeta, event_weight );	
										histosTH1F["muonDeltaPhi_dy_rpplus_accept"]->Fill(deltaphi, event_weight );
										histosTH1F["muonDeltaY_dy_rpplus_accept"]->Fill(deltay, event_weight );  

										histosTH1F["dy_t_plus_rpplus_accept"]->Fill( fabs(t_proton_plus), event_weight );
										histosTH1F["dy_xi_plus_rpplus_accept"]->Fill( xi_proton_plus, event_weight );
										histosTH1F["muonDphi_dy_rpplus_accept"]->Fill(Dphi, event_weight );
										histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpplus_accept"]->Fill(dimuon_pt, deltaphi,event_weight ); 
									...
									if(proton_plus_t_range){
										...
										if(((dimuon_mass > low_Bin) && (dimuon_mass < high_Bin))){  
											...
											//cout<<"dy_mass = "<< dy_mass << endl;
											++n_dy_selected_rp_accept_tsel_plus_side;
											//histosTH1F["dy_multiplicity_rp_accept"]->Fill(n_dimuons_selected, event_weight );
											histosTH1F["dy_mass_rpplus_accept_tsel"]->Fill(dy_mass, event_weight );
											histosTH1F["dy_pt_rpplus_accept_tsel"]->Fill( dy_pt, event_weight );
											histosTH1F["dy_pt2_rpplus_accept_tsel"]->Fill( dy_pt2, event_weight );
											histosTH1F["dy_eta_rpplus_accept_tsel"]->Fill( dy_eta, event_weight );
											histosTH1F["dy_rapidity_rpplus_accept_tsel"]->Fill( dy_rapidity, event_weight );
											histosTH1F["muonDeltaPt_dy_rpplus_accept_tsel"]->Fill(deltapt, event_weight );
											histosTH1F["muonDeltaEta_dy_rpplus_accept_tsel"]->Fill(deltaeta, event_weight );	
											histosTH1F["muonDeltaPhi_dy_rpplus_accept_tsel"]->Fill(deltaphi, event_weight );
											histosTH1F["muonDeltaY_dy_rpplus_accept_tsel"]->Fill(deltay, event_weight );  
											//cout<<"dy_t_plus_rpplus_accept_tsel"<<fabs(t_proton_plus)<<endl;
											histosTH1F["dy_t_plus_rpplus_accept_tsel"]->Fill( fabs(t_proton_plus), event_weight );
											histosTH1F["dy_xi_plus_rpplus_accept_tsel"]->Fill( xi_proton_plus, event_weight );
											histosTH1F["muonDphi_dy_rpplus_accept_tsel"]->Fill(Dphi, event_weight );
											histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpplus_accept_tsel"]->Fill(dimuon_pt,deltaphi, event_weight ); 
										}
							...
							if(sdminus){
								if( proton_minus_rp_accept  && dimuon_pt <= ptMax){// && xi_proton_minus  < 0.23){
									...
									if(((dimuon_mass > low_Bin) && (dimuon_mass < high_Bin))){  
										...
										//cout<<"dy_mass = "<< dy_mass << endl;
										++n_dy_selected_rp_accept_minus_side;

										histosTH1F["dy_mass_rpminus_accept"]->Fill(dy_mass, event_weight );
										histosTH1F["dy_pt_rpminus_accept"]->Fill( dy_pt, event_weight );
										histosTH1F["dy_pt2_rpminus_accept"]->Fill( dy_pt2, event_weight );
										histosTH1F["dy_eta_rpminus_accept"]->Fill( dy_eta, event_weight );
										histosTH1F["dy_rapidity_rpminus_accept"]->Fill( dy_rapidity, event_weight );
										histosTH1F["muonDeltaPt_dy_rpminus_accept"]->Fill(deltapt, event_weight );
										histosTH1F["muonDeltaEta_dy_rpminus_accept"]->Fill(deltaeta, event_weight );	
										histosTH1F["muonDeltaPhi_dy_rpminus_accept"]->Fill(deltaphi, event_weight );
										histosTH1F["muonDeltaY_dy_rpminus_accept"]->Fill(deltay, event_weight );  

										histosTH1F["dy_t_minus_rpminus_accept"]->Fill( fabs(t_proton_minus), event_weight );
										histosTH1F["dy_xi_minus_rpminus_accept"]->Fill( xi_proton_minus, event_weight );
										histosTH1F["muonDphi_dy_rpminus_accept"]->Fill(Dphi, event_weight );

										histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpminus_accept"]->Fill(dimuon_pt,deltaphi, event_weight ); 
									...
									if(proton_minus_t_range){
										...
										if(((dimuon_mass > low_Bin) && (dimuon_mass < high_Bin))){  
											...
											//cout<<"dy_mass = "<< dy_mass << endl;
											++n_dy_selected_rp_accept_tsel_minus_side;

											histosTH1F["dy_mass_rpminus_accept_tsel"]->Fill(dy_mass, event_weight );
											histosTH1F["dy_pt_rpminus_accept_tsel"]->Fill( dy_pt, event_weight );
											histosTH1F["dy_pt2_rpminus_accept_tsel"]->Fill( dy_pt2, event_weight );
											histosTH1F["dy_eta_rpminus_accept_tsel"]->Fill( dy_eta, event_weight );
											histosTH1F["dy_rapidity_rpminus_accept_tsel"]->Fill( dy_rapidity, event_weight );
											histosTH1F["muonDeltaPt_dy_rpminus_accept_tsel"]->Fill(deltapt, event_weight );
											histosTH1F["muonDeltaEta_dy_rpminus_accept_tsel"]->Fill(deltaeta, event_weight );	
											histosTH1F["muonDeltaPhi_dy_rpminus_accept_tsel"]->Fill(deltaphi, event_weight );
											histosTH1F["muonDeltaY_dy_rpminus_accept_tsel"]->Fill(deltay, event_weight );  
											//cout<<"dy_t_plus_rpminus_accept_tsel"<<fabs(t_proton_minus)<<endl;
											histosTH1F["dy_t_minus_rpminus_accept_tsel"]->Fill( fabs(t_proton_minus), event_weight );
											histosTH1F["dy_xi_minus_rpminus_accept_tsel"]->Fill( xi_proton_minus, event_weight );
											histosTH1F["muonDphi_dy_rpminus_accept_tsel"]->Fill(Dphi, event_weight );
											histosTH2F["dy_DeltaPhi_vs_dimuon_pt_rpminus_accept_tsel"]->Fill(dimuon_pt,deltaphi, event_weight ); 
					...
					cout<<"n_dy_selected="<< n_dy_selected<<endl;
					cout<<"n_dy_proton_left="<<n_dy_proton_left<<endl;
					cout<<"n_dy_proton_right="<<n_dy_proton_right<<endl;
					cout<<"n_dy_t_selected_proton_left="<< n_dy_t_selected_proton_left<<endl;
					//cout<<"n_dy_t_at_xi_selected_proton_left="<< n_dy_t_at_xi_selected_proton_left<<endl;
					cout<<"n_dy_t_selected_proton_right="<< n_dy_t_selected_proton_right<<endl;
					//cout<<"n_dy_t_at_xi_selected_proton_right="<< n_dy_t_at_xi_selected_proton_right<<endl;	
					...
					cout<<"n_dy_selected_rp_accept_plus_side ="<< n_dy_selected_rp_accept_plus_side<<endl;
					cout<<"n_dy_selected_rp_accept_tsel_plus_side ="<< n_dy_selected_rp_accept_tsel_plus_side<<endl;
					...
					cout<<"n_dy_selected_rp_accept_minus_side ="<< n_dy_selected_rp_accept_minus_side<<endl;
					cout<<"n_dy_selected_rp_accept_tsel_minus_side ="<< n_dy_selected_rp_accept_tsel_minus_side<<endl;
