...
void analysis_UATree_DYmuons_V01(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.003, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.01,const Double_t xi_proton_up_=0.15,const Int_t Bin_mass=200 ,const Int_t nevt_max = 57754){
	...
	histosTH1F["proton_right_xi_t_cut"] = new TH1F("proton_right_xi_t_selected", "#xi" ,  30,-1.0,1.0);///28 , xi_bins);
	histosTH1F["proton_right_t_t_cut"] = new TH1F("proton_right_t_t_selected", "|t|" ,  20,-1.0,1.0);///11 , tbins);
	...
	histosTH1F["proton_right_xi_t_cut_xi_cut"] = new TH1F("proton_right_xi_selected_t_and_xi", "#xi" , 30,-1.0,1.0);//28 , xi_bins);
	histosTH1F["proton_right_t_t_cut_xi_cut"] = new TH1F("proton_right_t_selected_t_and_xi", "|t|" , 20,-1.0,1.0);// 11 , tbins);
	...
	histosTH1F["proton_left_xi_t_cut"] = new TH1F("proton_left_xi_t_selected", "#xi" , 30,-1.0,1.0);//28 , xi_bins);
	histosTH1F["proton_left_t_t_cut"] = new TH1F("proton_left_t_t_selected", "|t|" , 20,-1.0,1.0);//11 , tbins);
	...
	histosTH1F["proton_left_xi_t_cut_xi_cut"] = new TH1F("proton_left_xi_selected_t_and_xi ", "#xi" ,30,-1.0,1.0);// 28 ,xi_bins);
	histosTH1F["proton_left_t_t_cut_xi_cut"] = new TH1F("proton_left_t_selected_t_and_xi", "|t|" , 11,-1.0,1.0);//11 , tbins);
				...
				for(vector<MyMuon>::iterator it_mu2 = muons_selected.begin() ;
					...
					if( good_proton_right ){
						...
						if ((fabs(t_proton_right)>t_proton_down_) && (fabs(t_proton_right)<t_proton_up_)){
							...
							histosTH1F["dimuon_mass_t_cut_proton_right"]->Fill( dimuon_lorentz.M(), event_weight );
							histosTH1F["dimuon_pt_t_cut_proton_right"]->Fill( dimuon_lorentz.Pt(), event_weight );
							histosTH1F["dimuon_eta_t_cut_proton_right"]->Fill( dimuon_lorentz.Eta(), event_weight );
							histosTH1F["dimuon_rapidity_t_cut_proton_right"]->Fill( dimuon_lorentz.Rapidity(), event_weight );
							histosTH1F["proton_right_xi_t_cut"]->Fill( xi_proton_right, event_weight );
							histosTH1F["proton_right_t_t_cut"]->Fill( fabs(t_proton_right), event_weight );
	...
	//							 xi_proton_right = -xi_proton_right;
					...
					if( good_proton_left ){
						...
						if ((fabs(t_proton_left)>t_proton_down_) && (fabs(t_proton_left)<t_proton_up_)){//(x>0.03 && x<1.0)
							...
							histosTH1F["dimuon_mass_t_cut_proton_left"]->Fill( dimuon_lorentz.M(), event_weight );
							histosTH1F["dimuon_pt_t_cut_proton_left"]->Fill( dimuon_lorentz.Pt(), event_weight );
							histosTH1F["dimuon_eta_t_cut_proton_left"]->Fill( dimuon_lorentz.Eta(), event_weight );
							histosTH1F["dimuon_rapidity_t_cut_proton_left"]->Fill( dimuon_lorentz.Rapidity(), event_weight );
							histosTH1F["proton_left_xi_t_cut"]->Fill( xi_proton_left, event_weight );
							histosTH1F["proton_left_t_t_cut"]->Fill( fabs(t_proton_left), event_weight );
