...
void analysis_UATree_DYmuons_V02(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.003, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.01,const Double_t xi_proton_up_=0.15,const Int_t Bin_mass=200 ,const Int_t nevt_max = 57754){
	...
	histosTH1F["dimuon_mass"] = new TH1F("dimuon_mass", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
	histosTH1F["dimuon_pt"] = new TH1F("dimuon_pt", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
	histosTH1F["dimuon_pt2"] = new TH1F("dimuon_pt2", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 1000.);
...
/////////////////////////////////////
        // included PT dimuon selection
        histosTH1F["dimuon_mass_sel_pt"] = new TH1F("dimuon_mass_sel_pt", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
        histosTH1F["dimuon_pt_sel_pt"] = new TH1F("dimuon_pt_sel_pt", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
        histosTH1F["dimuon_pt2_sel_pt"] = new TH1F("dimuon_pt2_sel_pt", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 150.);
        histosTH1F["dimuon_eta_sel_pt"] = new TH1F("dimuon_eta_sel_pt", "#eta(mu1,mu2)" , 200 , -5.2 , 5.2);
        histosTH1F["dimuon_rapidity_sel_pt"] = new TH1F("dimuon_rapidity_sel_pt", "y(mu1,mu2)" , 200 , -15. , 15.);
        histosTH1F["dimuon_multiplicity_sel_pt"] = new TH1F("dimuon_multiplicity_sel_pt", "n dimuons" , 100 , 0 , 100);
        //Deltas info
        histosTH1F["muonDeltaPt_sel_pt"] = new TH1F("muonDeltaPt_sel_pt", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
        histosTH1F["muonDeltaEta_sel_pt"] = new TH1F("muonDeltaEta_sel_pt", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
        histosTH1F["muonDeltaPhi_sel_pt"] = new TH1F("muonDeltaPhi_sel_pt", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDphi_sel_pt"] = new TH1F("muonDphi_sel_pt", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_sel_pt"] = new TH1F("muonDeltaY_sel_pt", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
///////////////////////////////////////////////////////////////////////////////////////////
 // included PT dimuon + Invariant mass selection
        histosTH1F["dimuon_mass_sel_pt_Mass"] = new TH1F("dimuon_mass_sel_pt_Mass", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
        histosTH1F["dimuon_pt_sel_pt_Mass"] = new TH1F("dimuon_pt_sel_pt_Mass", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
        histosTH1F["dimuon_pt2_sel_pt_Mass"] = new TH1F("dimuon_pt2_sel_pt_Mass", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 150.);
        histosTH1F["dimuon_eta_sel_pt_Mass"] = new TH1F("dimuon_eta_sel_pt_Mass", "#eta(mu1,mu2)" , 200 , -5.2 , 5.2);
        histosTH1F["dimuon_rapidity_sel_pt_Mass"] = new TH1F("dimuon_rapidity_sel_pt_Mass", "y(mu1,mu2)" , 200 , -15. , 15.);
        histosTH1F["dimuon_multiplicity_sel_pt_Mass"] = new TH1F("dimuon_multiplicity_sel_pt_Mass", "n dimuons" , 100 , 0 , 100);
        //Deltas info
        histosTH1F["muonDeltaPt_sel_pt_Mass"] = new TH1F("muonDeltaPt_sel_pt_Mass", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
        histosTH1F["muonDeltaEta_sel_pt_Mass"] = new TH1F("muonDeltaEta_sel_pt_Mass", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);
        histosTH1F["muonDeltaPhi_sel_pt_Mass"] = new TH1F("muonDeltaPhi_sel_pt_Mass", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDphi_sel_pt_Mass"] = new TH1F("muonDphi_sel_pt_Mass", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_sel_pt_Mass"] = new TH1F("muonDeltaY_sel_pt_Mass", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	//_t_cut_proton_right
	histosTH1F["dimuon_mass_t_cut_proton_right"] = new TH1F("dimuon_mass_t_cut_proton_right", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
	histosTH1F["dimuon_pt_t_cut_proton_right"] = new TH1F("dimuon_pt_t_cut_proton_right", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
        histosTH1F["dimuon_pt2_t_cut_proton_right"] = new TH1F("dimuon_pt2_t_cut_proton_right", "p_{T}^(2)(mu1,mu2)" , 150 , 0. , 1000.);
	...
	histosTH1F["muonDeltaPt_t_cut_proton_right"] = new TH1F("muonDeltaPt_t_cut_proton_right", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
        ...
        histosTH1F["muonDeltaPhi_t_cut_proton_right"] = new TH1F("muonDeltaPhi_t_cut_proton_right", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        //histosTH1F["muonDphi_t_cut_proton_right"] = new TH1F("muonDphi_t_cut_proton_right", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_t_cut_proton_right"] = new TH1F("muonDeltaY_t_cut_proton_right", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	histosTH1F["proton_right_xi_t_cut"] = new TH1F("proton_right_xi_t_selected", "#xi" , 100,0.0,1.0);//28 , xi_bins);
	histosTH1F["proton_right_t_t_cut"] = new TH1F("proton_right_t_t_selected", "|t|" ,  100,0.0,5.0);///11 , tbins);

	//t_cut_xi_cut_proton_right
	histosTH1F["dimuon_mass_t_cut_xi_cut_proton_right"] = new TH1F("dimuon_mass_t_cut_xi_cut_proton_right", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
	histosTH1F["dimuon_pt_t_cut_xi_cut_proton_right"] = new TH1F("dimuon_pt_t_cut_xi_cut_proton_right", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
	histosTH1F["dimuon_pt2_t_cut_xi_cut_proton_right"] = new TH1F("dimuon_pt2_t_cut_xi_cut_proton_right", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 1000.);
	...
	histosTH1F["dimuon_multiplicity_t_cut_xi_cut_proton_right"] = new TH1F("dimuon_multiplicity_t_cut_xi_cut_proton_right", "n dimuons" , 100 , 0 , 100);
	 //Deltas info
        ...
        histosTH1F["muonDeltaPhi_t_cut_xi_cut_proton_right"] = new TH1F("muonDeltaPhi_t_cut_xi_cut_proton_right", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
       // histosTH1F["muonDphi_t_cut_xi_cut_proton_right"] = new TH1F("muonDphi_t_cut_xi_cut_proton_right", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_t_cut_xi_cut_proton_right"] = new TH1F("muonDeltaY_t_cut_xi_cut_proton_right", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	histosTH1F["proton_right_xi_t_cut_xi_cut"] = new TH1F("proton_right_xi_selected_t_and_xi", "#xi" , 100,0.0,1.0);//28 , xi_bins);
	histosTH1F["proton_right_t_t_cut_xi_cut"] = new TH1F("proton_right_t_selected_t_and_xi", "|t|" , 100,0.0,5.0);// 11 , tbins);

	//_t_cut_proton_left
	histosTH1F["dimuon_mass_t_cut_proton_left"] = new TH1F("dimuon_mass_t_cut_proton_left", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
	histosTH1F["dimuon_pt_t_cut_proton_left"] = new TH1F("dimuon_pt_t_cut_proton_left", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
	histosTH1F["dimuon_pt2_t_cut_proton_left"] = new TH1F("dimuon_pt2_t_cut_proton_left", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 1000.);
	...
	histosTH1F["dimuon_multiplicity_t_cut_proton_left"] = new TH1F("dimuon_multiplicity_t_cut_proton_left", "n dimuons" , 100 , 0 , 100);
       //Deltas info
        ...
        histosTH1F["muonDeltaPhi_t_cut_proton_left"] = new TH1F("muonDeltaPhi_t_cut_proton_left", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        //histosTH1F["muonDphi_t_cut_proton_left"] = new TH1F("muonDphi_t_cut_proton_left", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_t_cut_proton_left"] = new TH1F("muonDeltaY_t_cut_proton_left", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	histosTH1F["proton_left_xi_t_cut"] = new TH1F("proton_left_xi_t_selected", "#xi" , 100,0.0,1.0);//28 , xi_bins);
	histosTH1F["proton_left_t_t_cut"] = new TH1F("proton_left_t_t_selected", "|t|" , 100,0.0,5.0);//11 , tbins);
	//t_cut_xi_cut_proton_left
	histosTH1F["dimuon_mass_t_cut_xi_cut_proton_left"] = new TH1F("dimuon_mass_t_cut_xi_cut_proton_left", "mass(mu1,mu2)" , Bin_mass , 20. , 120.);
	histosTH1F["dimuon_pt_t_cut_xi_cut_proton_left"] = new TH1F("dimuon_pt_t_cut_xi_cut_proton_left", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
	histosTH1F["dimuon_pt2_t_cut_xi_cut_proton_left"] = new TH1F("dimuon_pt2_t_cut_xi_cut_proton_left", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 1000.);
	...
	histosTH1F["dimuon_multiplicity_t_cut_xi_cut_proton_left"] = new TH1F("dimuon_multiplicity_t_cut_xi_cut_proton_left", "n dimuons" , 100 , 0 , 100);
        ...
        histosTH1F["muonDeltaPhi_t_cut_xi_cut_proton_left"] = new TH1F("muonDeltaPhi_t_cut_xi_cut_proton_left", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        //histosTH1F["muonDphi_t_cut_xi_cut_proton_left"] = new TH1F("muonDphi_t_cut_xi_cut_proton_left", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_t_cut_xi_cut_proton_left"] = new TH1F("muonDeltaY_t_cut_xi_cut_proton_left", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);

	histosTH1F["proton_left_xi_t_cut_xi_cut"] = new TH1F("proton_left_xi_selected_t_and_xi ", "#xi" ,100,0.0,1.0);// 28 ,xi_bins);
	histosTH1F["proton_left_t_t_cut_xi_cut"] = new TH1F("proton_left_t_selected_t_and_xi", "|t|" , 100,0.0,5.0);//11 , tbins);
	...
	histosTH1F["proton_right_xi"] = new TH1F("proton_right_xi", "#xi" ,  30,-1.0,1.0);//28 , xi_bins);
	histosTH1F["proton_right_logXi"] = new TH1F("proton_right_logXi","log(#xi)",200,-5.,0.);
	histosTH1F["proton_right_t"] = new TH1F("proton_right_t", "-t" ,  20,-1.0,1.0);//11 , tbins);
	histosTH1F["proton_right_chi2"] = new TH1F("proton_right_chi2", "#chi^{2}" , 100 , 0. , 100.);
	histosTH1F["proton_left_xi"] = new TH1F("proton_left_xi", "#xi" ,  30,-1.0,1.0);//28 ,xi_bins);
	histosTH1F["proton_left_logXi"] = new TH1F("proton_left_logXi","log(#xi)",200,-5.,0.);
	histosTH1F["proton_left_t"] = new TH1F("proton_left_t", "-t" , 20,-1.0,1.0);// 11 , tbins);
	...
	for(vector<TString>::iterator itfiles = vfiles->begin() ; itfiles != vfiles->end() && i_tot < nevt_max_corr ; ++itfiles){
		...
		int n_dimuons_selected_pT_sel = 0;
         	int n_dimuons_selected_pT_Mass_sel = 0;
		...
		for(int i_evt = 0; i_evt < nev && i_tot < nevt_max_corr; ++i_evt , ++i_tot){
			...
			if( good_proton_right ){
				...
				if(verbose) cout << "t_proton_right_without selection:" << t_proton_right << endl;
				if(-xi_proton_right > 0.){
					...
					if (fabs(t_proton_right)<t_proton_down_ || fabs(t_proton_right)>t_proton_up_){
						...
						}// selection in xi right
					} //selection in t right
					*/
				}
			}
			...
			if( good_proton_left ){
				...
				if(verbose)  cout << "t_proton_left_without selection:" << t_proton_left << endl;
				...
				if(-xi_proton_left > 0.){
					...
					if (fabs(t_proton_left)<t_proton_down_ || fabs(t_proton_left)>t_proton_up_){
						...
						}// xi selection in right side		


					}// tt selection in left side
				*/
				}
			}
			...
			double deltaphi = 0.;double deltaeta = 0.;double deltapt = 0.;double deltay = 0.;
			//------------------
			// Muon pairs
			for(vector<MyMuon>::iterator it_mu1 = muons_selected.begin() ;
				...
				for(vector<MyMuon>::iterator it_mu2 = muons_selected.begin() ;
					...
					histosTH1F["dimuon_pt2"]->Fill( (dimuons_pt*dimuons_pt), event_weight );
					...
					deltapt = fabs(muon1_lorentz.Pt() - muon2_lorentz.Pt());
                                        ...
                                        deltaphi = fabs(muon1_lorentz.Phi() - muon2_lorentz.Phi());
					...
					// pT Dimuons selection
                                        bool dimuons_pt_cut = dimuons_pt >= 1.5;// GeV
                                        if( !dimuons_pt_cut ) continue;
                                        n_dimuons_selected_pT_sel++;
                                        histosTH1F["dimuon_mass_sel_pt"]->Fill( dimuons_mass, event_weight );
                                        histosTH1F["dimuon_pt_sel_pt"]->Fill( dimuons_pt, event_weight );
                                        histosTH1F["dimuon_pt2_sel_pt"]->Fill( dimuons_pt*dimuons_pt, event_weight );
                                        histosTH1F["dimuon_eta_sel_pt"]->Fill( dimuons_eta, event_weight );
                                        histosTH1F["dimuon_rapidity_sel_pt"]->Fill( dimuons_rapidity, event_weight );
                                        histosTH1F["muonDeltaPt_sel_pt"]->Fill(deltapt, event_weight );
                                        histosTH1F["muonDeltaEta_sel_pt"]->Fill(deltaeta, event_weight );        
                                        histosTH1F["muonDeltaPhi_sel_pt"]->Fill(deltaphi, event_weight );
                                        histosTH1F["muonDeltaY_sel_pt"]->Fill(deltay, event_weight );
                                        // Low Window 20 < Mll< 66 GeV
                                        bool dimuons_mass_sel = ((dimuons_mass>20.0) && (dimuons_mass<66.0));
                                        if (!dimuons_mass_sel) continue;
                                        n_dimuons_selected_pT_Mass_sel++;
                                        histosTH1F["dimuon_mass_sel_pt_Mass"]->Fill( dimuons_mass, event_weight );
                                        histosTH1F["dimuon_pt_sel_pt_Mass"]->Fill( dimuons_pt, event_weight );
                                        histosTH1F["dimuon_pt2_sel_pt_Mass"]->Fill( dimuons_pt*dimuons_pt, event_weight );
                                        histosTH1F["dimuon_eta_sel_pt_Mass"]->Fill( dimuons_eta, event_weight );
                                        histosTH1F["dimuon_rapidity_sel_pt_Mass"]->Fill( dimuons_rapidity, event_weight );                
                                        histosTH1F["muonDeltaPt_sel_pt_Mass"]->Fill(deltapt, event_weight );
                                        histosTH1F["muonDeltaEta_sel_pt_Mass"]->Fill(deltaeta, event_weight );
                                        histosTH1F["muonDeltaPhi_sel_pt_Mass"]->Fill(deltaphi, event_weight );
                                        histosTH1F["muonDeltaY_sel_pt_Mass"]->Fill(deltay, event_weight );
					...
					if( good_proton_right ){
						...
						if ((fabs(t_proton_right)>t_proton_down_) && (fabs(t_proton_right)<t_proton_up_)){
							...
							if(verbose) cout<< "t proton right:"<< "["<< t_proton_right << "]"<< endl;


							histosTH1F["dimuon_multiplicity_t_cut_proton_right"]->Fill(n_dimuons_selected, event_weight );
							histosTH1F["dimuon_mass_t_cut_proton_right"]->Fill( dimuons_mass, event_weight );
							histosTH1F["dimuon_pt_t_cut_proton_right"]->Fill(dimuons_pt, event_weight );
							histosTH1F["dimuon_pt2_t_cut_proton_right"]->Fill( (dimuons_pt*dimuons_pt), event_weight );
							histosTH1F["dimuon_eta_t_cut_proton_right"]->Fill( dimuons_eta, event_weight );
							histosTH1F["dimuon_rapidity_t_cut_proton_right"]->Fill( dimuons_rapidity, event_weight );
	...
	//							 xi_proton_right = -xi_proton_right;
								...
								histosTH1F["dimuon_mass_t_cut_xi_cut_proton_right"]->Fill( dimuons_mass, event_weight );
								histosTH1F["dimuon_pt_t_cut_xi_cut_proton_right"]->Fill( dimuons_pt, event_weight );
								histosTH1F["dimuon_pt2_t_cut_xi_cut_proton_right"]->Fill( (dimuons_pt*dimuons_pt), event_weight );
								histosTH1F["dimuon_eta_t_cut_xi_cut_proton_right"]->Fill( dimuons_eta, event_weight );
								histosTH1F["dimuon_rapidity_t_cut_xi_cut_proton_right"]->Fill( dimuons_rapidity, event_weight );
					...
					if( good_proton_left ){
						double t_proton_left = rec_proton_left->t;
						if ((fabs(t_proton_left)>t_proton_down_) && (fabs(t_proton_left)<t_proton_up_)){//(x>0.03 && x<1.0)
							n_dimuons_t_selected_proton_left++;	
							if(verbose) cout<< "t proton left side (abs):"<< "["<< t_proton_down_  << ","<< t_proton_up_ << "]"<< endl;
							if(verbose) cout<< "t proton left:"<< "["<< t_proton_left << "]"<< endl;

							histosTH1F["dimuon_multiplicity_t_cut_proton_left"]->Fill(n_dimuons_selected, event_weight );
							histosTH1F["dimuon_mass_t_cut_proton_left"]->Fill( dimuons_mass, event_weight );
							histosTH1F["dimuon_pt_t_cut_proton_left"]->Fill( dimuons_pt, event_weight );
							histosTH1F["dimuon_pt2_t_cut_proton_left"]->Fill( (dimuons_pt*dimuons_pt), event_weight );
							histosTH1F["dimuon_eta_t_cut_proton_left"]->Fill( dimuons_eta, event_weight );
							histosTH1F["dimuon_rapidity_t_cut_proton_left"]->Fill( dimuons_rapidity, event_weight );
	...
	//							 xi_proton_left = -xi_proton_left;
								...
								histosTH1F["dimuon_mass_t_cut_xi_cut_proton_left"]->Fill( dimuons_mass, event_weight );
								histosTH1F["dimuon_pt_t_cut_xi_cut_proton_left"]->Fill( dimuons_pt, event_weight );
								histosTH1F["dimuon_pt2_t_cut_xi_cut_proton_left"]->Fill( (dimuons_pt*dimuons_pt), event_weight );
								histosTH1F["dimuon_eta_t_cut_xi_cut_proton_left"]->Fill(dimuons_eta, event_weight );
								histosTH1F["dimuon_rapidity_t_cut_xi_cut_proton_left"]->Fill( dimuons_rapidity, event_weight );
		...
		cout<<"n_dimuons_selected_pT_sel= "<< n_dimuons_selected_pT_sel<<endl;
                cout<<"n_dimuons_selected_pT_Mass_sel= "<< n_dimuons_selected_pT_Mass_sel<<endl;
