 ...
 */
void CMS_MC_POMPTY_DY_plus_v03(vector<string> const& fileNames, string const& outputFileName = "output.root", const Double_t t_proton_down_=0.003, const Double_t t_proton_up_=1.0, const Double_t xi_proton_down_=0.01,const Double_t xi_proton_up_=0.15,const Int_t Bin_mass=200 ,const Int_t nevt_max = -1){
	...
	histosTH1F["dimuon_pt2"] = new TH1F("dimuon_pt2", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 150.);
...
//////////////////////////////////////////////////////////////////
	...
	histosTH1F["dimuon_pt2_rp_accept"] = new TH1F("dimuon_pt2_rp_accept", "p_{T}^{2}(mu1,mu2)" , 150 , 0. , 1000.);
	...
	//Deltas info
        ...
        histosTH1F["muonDeltaPhi_rp_accept"] = new TH1F("muonDeltaPhi_rp_accept", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDphi_rp_accept"] = new TH1F("muonDphi_rp_accept", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
        histosTH1F["muonDeltaY_rp_accept"] = new TH1F("muonDeltaY_rp_accept", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);


	// Reco Muons rp_accept && _sel t and xi
	histosTH1F["dimuon_mass_rp_accept_sel"] = new TH1F("dimuon_mass_rp_accept_sel", "mass(mu1,mu2)" , Bin_mass , 0. , 120.);
	histosTH1F["dimuon_pt_rp_accept_sel"] = new TH1F("dimuon_pt_rp_accept_sel", "p_{T}(mu1,mu2)" , 150 , 0. , 150.);
	histosTH1F["dimuon_pt2_rp_accept_sel"] = new TH1F("dimuon_pt2_rp_accept_sel", "p_{T}2(mu1,mu2)" , 100 , 0. , 1000.);
	histosTH1F["dimuon_eta_rp_accept_sel"] = new TH1F("dimuon_eta_rp_accept_sel", "#eta(mu1,mu2)" , 100 , -5.2 , 5.2);
	histosTH1F["dimuon_rapidity_rp_accept_sel"] = new TH1F("dimuon_rapidity_rp_accept_sel", "y(mu1,mu2)" , 200 , -15. , 15.);
	//histosTH1F["dimuon_multiplicity_rp_accept_tsel"] = new TH1F("dimuon_multiplicity_rp_accept", "n dimuons" , 100 , 0 , 100);
	histosTH1F["muonDeltaPt_rp_accept_sel"] = new TH1F("muonDeltaPt_rp_accept_sel", "#Deltap_{T}(mu1,mu2)" , 100 , 0. , 100.);
	histosTH1F["muonDeltaEta_rp_accept_sel"] = new TH1F("muonDeltaEta_rp_accept_sel", "#Delta#eta(mu1,mu2)" , 100 , 0. , 10.);	
	histosTH1F["muonDeltaPhi_rp_accept_sel"] = new TH1F("muonDeltaPhi_rp_accept_sel", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
	histosTH1F["muonDphi_rp_accept_sel"] = new TH1F("muonDphi_rp_accept_tsel", "#Delta#phi(mu1,mu2)" , 100 , -2*M_PI , 2*M_PI);
	histosTH1F["muonDeltaY_rp_accept_sel"] = new TH1F("muonDeltaY_rp_accept_sel", "#Deltay(mu1,mu2)" , 100 , 0. , 10.);
	histosTH1F["dimuon_xi_plus_rp_accept_sel"]= new TH1F("dimuon_xi_plus_rp_accept_sel", "#xi^{+}" , 100,0.0,1.0);
	histosTH1F["dimuon_t_plus_rp_accept_sel"] = new TH1F("dimuon_t_plus_rp_accept_sel", "|t|^{+}" , 100,0.0,5.0);
	...
	histosTH1F["xi_proton_plus"] = new TH1F("xi_proton_plus", "xi_proton_plus" ,   100,0.0,1.0);
	histosTH1F["t_proton_plus"] = new TH1F("t_proton_plus", "t_proton_plus" ,   100,0.0,5.0);
	...
	histosTH1F["xi_proton_minus"] = new TH1F("xi_proton_minus", "xi_proton_minus" ,  100,0.0,1.0);// 28, xi_bins);
	histosTH1F["t_proton_minus"] = new TH1F("t_proton_minus", "t_proton_minus" ,   100,0.0,5.0);//11, tbins);
	histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus_accepted",  20,-1.0,1.0);//, 11, tbins);
	...
	histosTH1F["xi_proton_plus"] = new TH1F("xi_proton_plus", "xi_proton_plus" ,  100,0.0,1.0);//28, xi_bins);
	histosTH1F["t_proton_plus"] = new TH1F("t_proton_plus", "t_proton_plus" ,100,0.0,5.0);//11, tbins);
	histosTH1F["t_proton_plus_newbinning"] = new TH1F("t_proton_plus_newbinning", "t_proton_plus" , 33, tbins_matrix);
	histosTH1F["t_proton_plus_accepted"] = new TH1F("t_proton_plus_accepted", "t_proton_plus_accepted" ,   100,0.0,5.0);//11, tbins);
	histosTH1F["t_proton_plus_accepted_newbinning"] = new TH1F("t_proton_plus_accepted_newbinning", "t_proton_plus" , 33, tbins_matrix);
	histosTH1F["thx_proton_plus"] = new TH1F("thx_proton_plus", "thx_proton_plus" , 200, -5e-4, 5e-4);
	histosTH1F["thy_proton_plus"] = new TH1F("thy_proton_plus", "thy_proton_plus" , 200, -5e-4, 5e-4);


	histosTH1F["xi_proton_plus_before_selection"] = new TH1F("xi_proton_plus_before_selection", "xi_proton_plus_before_selection" ,  100,0.0,1.0);//28, xi_bins);
	histosTH1F["t_proton_plus_before_selection"] = new TH1F("t_proton_plus_before_selection", "t_proton_plus_before_selection" ,   100,0.0,5.0);//11, tbins);
	//FIXME
	histosTH1F["xi_proton_minus_accepted"] = new TH1F("xi_proton_minus_accepted", "xi_proton_minus" ,  100,0.0,1.0);// 28, xi_bins);
	histosTH1F["xi_proton_plus_accepted"] = new TH1F("xi_proton_plus_accepted", "xi_proton_plus" ,   100,0.0,1.0);//28, xi_bins);

	// rp accept_selected
	histosTH1F["xi_proton_plus_rp_accept_sel"] = new TH1F("xi_proton_plus_rp_accept_sel", "xi_proton_plus_rp_accept_sel" ,  100,0.0,1.0);//28, xi_bins);
	histosTH1F["t_proton_plus_rp_accept_sel"] = new TH1F("t_proton_plus_rp_accept_sel", "t_proton_plus_rp_accept_sel" ,   100,0.0,5.0);				
	...
	int n_dimuons_rp_selected_sel_plus_side =0;
	...
	for(vector<TString>::iterator itfiles = vfiles->begin(); itfiles != vfiles->end() && i_tot < nevt_max_corr; ++itfiles){
		...
		for(int i_evt = 0; i_evt < nev && i_tot < nevt_max_corr; ++i_evt , ++i_tot){
			...
			for(vector<MyMuon>::iterator it_mu1 = muons_selected.begin() ;
				...
				histosTH1F["muon1_pt"]->Fill( ptmu1, event_weight );
				histosTH1F["muon1_eta"]->Fill(etamu1, event_weight );
				histosTH1F["muon1_rapidity"]->Fill( ymu1, event_weight );
				histosTH1F["muon1_phi"]->Fill(phimu1, event_weight );	
				...
				for(vector<MyMuon>::iterator it_mu2 = muons_selected.begin() ;
					...
					histosTH1F["muon2_pt"]->Fill( ptmu2, event_weight );
					histosTH1F["muon2_eta"]->Fill( etamu2, event_weight );
					histosTH1F["muon2_rapidity"]->Fill( ymu2, event_weight );
					histosTH1F["muon2_phi"]->Fill(phimu2, event_weight );
			...
			double pz_gen;
			double energy_gen;
			double proton_pf= 0.; double proton_in =0.;
			...
			histosTH1F["xi_proton_plus_before_selection"]->Fill( xi_proton_plus , event_weight );
			histosTH1F["t_proton_plus_before_selection"]->Fill( fabs(t_proton_plus) , event_weight );
			/*
			...
			TLorentzVector p4(proton_px_minus,proton_py_minus,proton_pz_minus,proton_energy_minus); // 4 momentum of p2
			t_proton_minus=(p1-p4).M2();
			...
			*/
			...
			if(proton_plus_rp_accept){//continue;
				...
				histosTH1F["dimuon_pt2_rp_accept"]->Fill( dimuons_pt*dimuons_pt, event_weight );
				...
				if ((fabs(t_proton_plus) > t_proton_down_) && (fabs(t_proton_plus)<t_proton_up_)){
					...
					if ((xi_proton_plus>xi_proton_down_) && (xi_proton_plus<xi_proton_up_)){
						...
						//----------------------------------------------
						//dimuons              
						++n_dimuons_rp_selected_sel_plus_side;	
						//histosTH1F["dimuon_multiplicity_rp_accept"]->Fill(n_dimuons_rp_selected_plus_side, event_weight );
						histosTH1F["dimuon_mass_rp_accept_sel"]->Fill( dimuons_mass, event_weight );
						histosTH1F["dimuon_pt_rp_accept_sel"]->Fill( dimuons_pt, event_weight );
						histosTH1F["dimuon_pt2_rp_accept_sel"]->Fill(dimuons_pt*dimuons_pt, event_weight );
						histosTH1F["dimuon_eta_rp_accept_sel"]->Fill( dimuons_eta, event_weight );
						histosTH1F["dimuon_rapidity_rp_accept_sel"]->Fill( dimuons_rapidity, event_weight );
						histosTH1F["muonDeltaPt_rp_accept_sel"]->Fill(deltapt, event_weight );
						histosTH1F["muonDeltaEta_rp_accept_sel"]->Fill(deltaeta, event_weight );	
						//histosTH1F["muonDphi_rp_accept_sel"]->Fill(Dphi, event_weight );
						histosTH1F["muonDeltaPhi_rp_accept_sel"]->Fill(deltaphi, event_weight );
						histosTH1F["muonDeltaY_rp_accept_sel"]->Fill(deltay, event_weight ); 


						histosTH1F["xi_proton_plus_rp_accept_sel"]->Fill( xi_proton_plus , event_weight );
						histosTH1F["t_proton_plus_rp_accept_sel"]->Fill( fabs(t_proton_plus) , event_weight );
		...
		cout<<"n_dimuons_rp_selected_sel_plus_side= "<< n_dimuons_rp_selected_sel_plus_side<<endl;
