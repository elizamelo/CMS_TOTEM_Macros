...
*/
void CMS_MC_POMWIG(string const& outputFileName = "mc_pomwig_minus.root", const Int_t nevt_max = -1){
...
//      histosTH1F["hltTrigFired"]->GetXaxis()->SetBinLabel( (k + 1) , hltPathNames[k].c_str() );
  ...
  histosTH1F["t_proton_minus"] = new TH1F("t_proton_minus", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin1"] = new TH1F("t_proton_minus_tbin1", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin2"] = new TH1F("t_proton_minus_tbin2", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin3"] = new TH1F("t_proton_minus_tbin3", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin4"] = new TH1F("t_proton_minus_tbin4", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin5"] = new TH1F("t_proton_minus_tbin5", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin6"] = new TH1F("t_proton_minus_tbin6", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin7"] = new TH1F("t_proton_minus_tbin7", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin8"] = new TH1F("t_proton_minus_tbin8", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_tbin9"] = new TH1F("t_proton_minus_tbin9", "t_proton_minus" , 80, 0., 1.);
  ...
  histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_plus_accepted_tbin1"] = new TH1F("t_proton_plus_accepted_tbin1", "t_proton_plus" , 80, 0., 1.);
  histosTH1F["t_proton_plus_accepted_tbin2"] = new TH1F("t_proton_plus_accepted_tbin2", "t_proton_plus" , 80, 0., 1.);
  histosTH1F["t_proton_plus_accepted_tbin3"] = new TH1F("t_proton_plus_accepted_tbin3", "t_proton_plus" , 80, 0., 1.);
  histosTH1F["t_proton_plus_accepted_tbin4"] = new TH1F("t_proton_plus_accepted_tbin4", "t_proton_plus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin1"] = new TH1F("t_proton_minus_accepted_tbin1", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin2"] = new TH1F("t_proton_minus_accepted_tbin2", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin3"] = new TH1F("t_proton_minus_accepted_tbin3", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin4"] = new TH1F("t_proton_minus_accepted_tbin4", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin5"] = new TH1F("t_proton_minus_accepted_tbin5", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin6"] = new TH1F("t_proton_minus_accepted_tbin6", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin7"] = new TH1F("t_proton_minus_accepted_tbin7", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin8"] = new TH1F("t_proton_minus_accepted_tbin8", "t_proton_minus" , 80, 0., 1.);
  histosTH1F["t_proton_minus_accepted_tbin9"] = new TH1F("t_proton_minus_accepted_tbin9", "t_proton_minus" , 80, 0., 1.);
...
*/
      ...
      if (fabs(xi_proton_minus)<0.03 || fabs(xi_proton_minus)>0.1) continue;
      ...
      if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
      if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.25 ){histosTH1F["t_proton_plus_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
      if (fabs(t_proton_plus)>0.25 && fabs(t_proton_plus)<0.35 ){histosTH1F["t_proton_plus_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
      if (fabs(t_proton_plus)>0.35 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      ...
      if (fabs(t_proton_minus)>0.24 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_tbin7"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<0.45 ){histosTH1F["t_proton_minus_tbin8"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.45 && fabs(t_proton_minus)<1.0 ){histosTH1F["t_proton_minus_tbin9"]->Fill( fabs(t_proton_minus) , event_weight );}
      ...
      if(proton_plus_rp_accept){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.25 ){histosTH1F["t_proton_plus_accepted_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.25 && fabs(t_proton_plus)<0.35 ){histosTH1F["t_proton_plus_accepted_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.35 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      if(proton_minus_rp_accept){
         ...
         if (fabs(t_proton_minus)>0.24 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_tbin7"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<0.45 ){histosTH1F["t_proton_minus_accepted_tbin8"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.45 && fabs(t_proton_minus)<1.0 ){histosTH1F["t_proton_minus_accepted_tbin9"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      ...
      if(proton_plus_rp_accept_020){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_020_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_020_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_020_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_020_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      if(proton_plus_rp_accept_021){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_021_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_021_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_021_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_021_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      if(proton_plus_rp_accept_022){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_022_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_022_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_022_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_022_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      if(proton_plus_rp_accept_023){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_023_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_023_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_023_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_023_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      if(proton_plus_rp_accept_024){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.1 ){histosTH1F["t_proton_plus_accepted_024_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_024_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_024_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_024_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      if(proton_plus_rp_accept_025){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_025_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_025_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_025_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_025_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
     }
      if(proton_plus_rp_accept_120){
         ...
         if (fabs(t_proton_plus)>0.03 && fabs(t_proton_plus)<0.15 ){histosTH1F["t_proton_plus_accepted_120_tbin1"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.15 && fabs(t_proton_plus)<0.2 ){histosTH1F["t_proton_plus_accepted_120_tbin2"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.2 && fabs(t_proton_plus)<0.3 ){histosTH1F["t_proton_plus_accepted_120_tbin3"]->Fill( fabs(t_proton_plus) , event_weight );}
         if (fabs(t_proton_plus)>0.3 && fabs(t_proton_plus)<1 ){histosTH1F["t_proton_plus_accepted_120_tbin4"]->Fill( fabs(t_proton_plus) , event_weight );}
      }
      ...
      if(proton_minus_rp_accept_120){
         ...
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_120_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_120_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_120_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_120_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      if(proton_minus_rp_accept_121){
         histosTH1F["xi_proton_minus_accepted_121"]->Fill( xi_proton_minus , event_weight );
         histosTH1F["t_proton_minus_accepted_121"]->Fill( fabs(t_proton_minus) , event_weight );
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_121_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_121_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_121_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_121_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      if(proton_minus_rp_accept_122){
         histosTH1F["xi_proton_minus_accepted_122"]->Fill( xi_proton_minus , event_weight );
         histosTH1F["t_proton_minus_accepted_122"]->Fill( fabs(t_proton_minus) , event_weight );
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_122_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_122_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_122_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_122_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      if(proton_minus_rp_accept_123){
         histosTH1F["xi_proton_minus_accepted_123"]->Fill( xi_proton_minus , event_weight );
         histosTH1F["t_proton_minus_accepted_123"]->Fill( fabs(t_proton_minus) , event_weight );
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_123_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_123_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_123_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_123_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      if(proton_minus_rp_accept_124){
         histosTH1F["xi_proton_minus_accepted_124"]->Fill( xi_proton_minus , event_weight );
         histosTH1F["t_proton_minus_accepted_124"]->Fill( fabs(t_proton_minus) , event_weight );
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_124_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_124_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_124_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_124_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      if(proton_minus_rp_accept_125){
         histosTH1F["xi_proton_minus_accepted_125"]->Fill( xi_proton_minus , event_weight );
         histosTH1F["t_proton_minus_accepted_125"]->Fill( fabs(t_proton_minus) , event_weight );
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_125_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_125_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_125_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_125_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
      if(proton_minus_rp_accept_020){
         ...
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.15 ){histosTH1F["t_proton_minus_accepted_020_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.15 && fabs(t_proton_minus)<0.2 ){histosTH1F["t_proton_minus_accepted_020_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.2 && fabs(t_proton_minus)<0.3 ){histosTH1F["t_proton_minus_accepted_020_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.3 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_020_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      }
...
*/ 
  float cross_section = 4.1259e6; //pb cross section for pomwig
...
//   Double_t scale_PF = 1.0/f3;
  ...
  histosTH1F["t_proton_minus_accepted_tbin1"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin2"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin3"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin4"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin5"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin6"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin7"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin8"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin9"]->Scale(scale);
  histosTH1F["t_proton_minus"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin1"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin2"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin3"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin4"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin5"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin6"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin7"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin8"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin9"]->Scale(scale);
