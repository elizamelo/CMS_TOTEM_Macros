...
*/
void CMS_MC_PYTHIA6(string const& outputFileName = "mc_pythia_minus.root", const Int_t nevt_max = -1){
...
//      histosTH1F["hltTrigFired"]->GetXaxis()->SetBinLabel( (k + 1) , hltPathNames[k].c_str() );
  ...
  histosTH1F["t_proton_minus"] = new TH1F("t_proton_minus", "t_proton_minus" , 200, 0., 5.);
  ...
  histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus" , 200, 0., 5.);
...
/*       histosTH1F["correction"]->Fill( correction, event_weight ); 
       ...
       :qhistosTH2F["logxi_minus_reco_gen"]->Fill( log10(xi_minus_gen), log10(xi_minus_Reco), event_weight ); 
...
*/
      ...
      if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.055 ){histosTH1F["t_proton_minus_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.055 && fabs(t_proton_minus)<0.08 ){histosTH1F["t_proton_minus_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.08 && fabs(t_proton_minus)<0.105 ){histosTH1F["t_proton_minus_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.105 && fabs(t_proton_minus)<0.14 ){histosTH1F["t_proton_minus_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.14 && fabs(t_proton_minus)<0.175 ){histosTH1F["t_proton_minus_tbin5"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.175 && fabs(t_proton_minus)<0.23 ){histosTH1F["t_proton_minus_tbin6"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.23 && fabs(t_proton_minus)<0.28 ){histosTH1F["t_proton_minus_tbin7"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.28 && fabs(t_proton_minus)<0.33 ){histosTH1F["t_proton_minus_tbin8"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.33 && fabs(t_proton_minus)<0.45 ){histosTH1F["t_proton_minus_tbin9"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.45 && fabs(t_proton_minus)<0.57 ){histosTH1F["t_proton_minus_tbin10"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.57 && fabs(t_proton_minus)<0.69 ){histosTH1F["t_proton_minus_tbin11"]->Fill( fabs(t_proton_minus) , event_weight );}
      if (fabs(t_proton_minus)>0.69 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_tbin12"]->Fill( fabs(t_proton_minus) , event_weight );}
     ...
     //cout<<"antes"<<endl; 
      ...
      //   if (xi_proton_minus<0.03 || xi_proton_minus>0.1)continue;
         ...
         histosTH1F["xi_proton_minus_accepted"]->Fill( xi_proton_minus , event_weight );
         histosTH2F["proton_minus_xi_vs_t_accepted"]->Fill( fabs(t_proton_minus) , xi_proton_minus , event_weight );
         if (fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.055 ){histosTH1F["t_proton_minus_accepted_tbin1"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.055 && fabs(t_proton_minus)<0.08 ){histosTH1F["t_proton_minus_accepted_tbin2"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.08 && fabs(t_proton_minus)<0.105 ){histosTH1F["t_proton_minus_accepted_tbin3"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.105 && fabs(t_proton_minus)<0.14 ){histosTH1F["t_proton_minus_accepted_tbin4"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.14 && fabs(t_proton_minus)<0.175 ){histosTH1F["t_proton_minus_accepted_tbin5"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.175 && fabs(t_proton_minus)<0.23 ){histosTH1F["t_proton_minus_accepted_tbin6"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.23 && fabs(t_proton_minus)<0.28 ){histosTH1F["t_proton_minus_accepted_tbin7"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.28 && fabs(t_proton_minus)<0.33 ){histosTH1F["t_proton_minus_accepted_tbin8"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.33 && fabs(t_proton_minus)<0.45 ){histosTH1F["t_proton_minus_accepted_tbin9"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.45 && fabs(t_proton_minus)<0.57 ){histosTH1F["t_proton_minus_accepted_tbin10"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.57 && fabs(t_proton_minus)<0.69 ){histosTH1F["t_proton_minus_accepted_tbin11"]->Fill( fabs(t_proton_minus) , event_weight );}
         if (fabs(t_proton_minus)>0.69 && fabs(t_proton_minus)<1 ){histosTH1F["t_proton_minus_accepted_tbin12"]->Fill( fabs(t_proton_minus) , event_weight );}
...
cout<<"sii"<<endl;
  ...
  histosTH1F["t_proton_minus_accepted_tbin10"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin11"]->Scale(scale);
  histosTH1F["t_proton_minus_accepted_tbin12"]->Scale(scale);
  ...
  histosTH1F["t_proton_minus_tbin10"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin11"]->Scale(scale);
  histosTH1F["t_proton_minus_tbin12"]->Scale(scale);
