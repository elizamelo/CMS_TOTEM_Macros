...
*/
void CMS_MC_POMWIG_minus_vertex_correction(string const& outputFileName = "mc_pomwig_minus_vertex_correction.root", const Int_t nevt_max = -1){
...
//      histosTH1F["hltTrigFired"]->GetXaxis()->SetBinLabel( (k + 1) , hltPathNames[k].c_str() );
  ...
  histosTH1F["t_proton_minus_newbinning"] = new TH1F("t_proton_minus_newbinning", "t_proton_minus" , 33, tbins_matrix);
  histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_accepted_newbinning"] = new TH1F("t_proton_minus_accepted_newbinning", "t_proton_minus" , 33, tbins_matrix);
 ...
 */     
	...
	if( it_vtx->ndof>4 ) passedvtx = true;   
      ...
      Double_t mean_xpos = 0.0752613;
      Double_t sigma_xpos = 0.0178582;
      Double_t mean_ypos = 0.0672555;
      Double_t sigma_ypos = 0.0149191;
      Double_t xpos_random = gRandom->Gaus(mean_xpos, sigma_xpos)/100;
      Double_t ypos_random = gRandom->Gaus(mean_ypos, sigma_ypos)/100;
      histosTH1F["vtx_xpos_random"]->Fill( xpos_random*100, event_weight );
...
//	 if (eta_gen<4.9 && eta_gen>-4.9){ xi_posit_gen = true;
	 ...
	 if (pz_gen > proton_pz_plus) {
      ...
      if(proton_pz_plus > 0.){
         ...
         proton_plus_rp_accept_021 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 21);
         proton_plus_rp_accept_022 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 22);
         proton_plus_rp_accept_023 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 23);
         proton_plus_rp_accept_024 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 24);
         proton_plus_rp_accept_025 = protonRPDetected(xpos_random, thx_proton_plus, ypos_random, thy_proton_plus, -xi_proton_plus, 25);
      ...
      if(proton_pz_minus < 0.){
         ...
         proton_minus_rp_accept_121 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 121);
         proton_minus_rp_accept_122 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 122);
         proton_minus_rp_accept_123 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 123);
         proton_minus_rp_accept_124 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 124);
         proton_minus_rp_accept_125 = protonRPDetected(xpos_random, thx_proton_minus, ypos_random, thy_proton_minus, -xi_proton_minus, 125);
