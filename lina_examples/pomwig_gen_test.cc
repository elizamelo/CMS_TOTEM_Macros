...
void pomwig_gen_test(string const& outputFileName = "mc_pomwig_minus_gen_vtx_correction_test.root", const Int_t nevt_max = -1){
...
//      histosTH1F["hltTrigFired"]->GetXaxis()->SetBinLabel( (k + 1) , hltPathNames[k].c_str() );
  ...
  histosTH1F["vtx_zpos_correction"] = new TH1F("vtx_zpos_correction", "z(vtx)" , 150 , -30. , 30.);
  ...
  Float_t tbins[12] = {0.03, 0.06, 0.09, 0.13, 0.16, 0.19, 0.24, 0.30, 0.36, 0.45, 0.65, 1.};//v3
  Float_t tbins_matrix[32] = { 0.04, 0.0576, 0.0784, 0.1024, 0.1296, 0.16, 0.1936, 0.2304, 0.2704, 0.3136, 0.36, 0.4096, 0.4624, 0.5184, 0.5778, 0.64, 0.7056, 0.7744, 0.8464, 0.9216, 1., 1.0816, 1.1664, 1.2544, 1.3456, 1.44, 1.5376, 1.6384, 1.7424, 1.8496, 1.96, 2.0736};
//  Float_t tbins[23] = {  0.03, 0.06, 0.09, 0.13, 0.16, 0.19, 0.24, 0.30, 0.36, 0.45, 0.65, 1., 1.0816, 1.1664, 1.2544, 1.3456, 1.44, 1.5376, 1.6384, 1.7424, 1.8496, 1.96, 2.0736};

  histosTH1F["t_proton_minus"] = new TH1F("t_proton_minus", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction"] = new TH1F("t_proton_minus_vtx_correction", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_newbinning"] = new TH1F("t_proton_minus_newbinning", "t_proton_minus" , 31, tbins_matrix);
  ...
  histosTH1F["t_proton_minus_vtx_correction_tbin1"] = new TH1F("t_proton_minus_vtx_correction_tbin1", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin2"] = new TH1F("t_proton_minus_vtx_correction_tbin2", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin3"] = new TH1F("t_proton_minus_vtx_correction_tbin3", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin4"] = new TH1F("t_proton_minus_vtx_correction_tbin4", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin5"] = new TH1F("t_proton_minus_vtx_correction_tbin5", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin6"] = new TH1F("t_proton_minus_vtx_correction_tbin6", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin7"] = new TH1F("t_proton_minus_vtx_correction_tbin7", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin8"] = new TH1F("t_proton_minus_vtx_correction_tbin8", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin9"] = new TH1F("t_proton_minus_vtx_correction_tbin9", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin10"] = new TH1F("t_proton_minus_vtx_correction_tbin10", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_vtx_correction_tbin11"] = new TH1F("t_proton_minus_vtx_correction_tbin11", "t_proton_minus" , 11, tbins);
  ...
  histosTH1F["t_proton_minus_accepted_vtx_correction"] = new TH1F("t_proton_minus_accepted_vtx_correction", "t_proton_minus" , 11, tbins);
  histosTH1F["t_proton_minus_accepted_newbinning"] = new TH1F("t_proton_minus_accepted_newbinning", "t_proton_minus" , 31, tbins_matrix);
...
//   const char *dirname="dcap://se-dcache.hepgrid.uerj.br:22138/pnfs/hepgrid.uerj.br/data/cms/store/user/lhuertas/MC/Pomwig_SD_8TeV/";
  ...
  //vtx_zpos correction
  TFile *input1 = new TFile("/storage1/lhuertas/Analysis/CMSTotem_RP/CMSTotem/Workspace/data_CMSTOTEM_right_vertex.root");
  TFile *input2 = new TFile("/storage1/lhuertas/Analysis/CMSTotem_RP/CMSTotem/Workspace/mc_pomwig_minus_vertex.root");
  vector<TH1F*> histos_input1;
  vector<TH1F*> histos_input2;
  TH1F * vtx_zpos = (TH1F*)input1->Get("vtx_zpos");histos_input1.push_back(vtx_zpos);
  TH1F * vtx_zpos_pomwig = (TH1F*)input2->Get("vtx_zpos");histos_input2.push_back(vtx_zpos_pomwig);
  double events_zpos_data = vtx_zpos->GetEntries();
  double events_zpos_mc = vtx_zpos_pomwig->GetEntries();
  vtx_zpos->Scale(1/events_zpos_data);
  vtx_zpos_pomwig->Scale(1/events_zpos_mc);
  vtx_zpos->Fit("gaus");
  vtx_zpos_pomwig->Fit("gaus");
  TF1 *fit_vtx_zpos = (TF1*)vtx_zpos->GetFunction("gaus");
  TF1 *fit_vtx_zpos_pomwig = (TF1*)vtx_zpos_pomwig->GetFunction("gaus");
...
//     tree->SetBranchAddress("HLTrig",&hltTrig);
    ...
    if( ((i_tot+1) % 10000) == 0) cout <<int(double(i_tot+1)/1000)<<"k done"<<endl;
     ...
     // Vertices
      ...
      double vtx_zpos_data = fit_vtx_zpos->Eval(zpos);
      double vtx_zpos_mc = fit_vtx_zpos_pomwig->Eval(zpos);
      double vtx_zpos_correction = vtx_zpos_data/vtx_zpos_mc;
      histosTH1F["vtx_zpos_correction"]->Fill( zpos, vtx_zpos_correction );
...
//       if(!PF_eta_min) continue;
      ...
      histosTH1F["t_proton_minus_vtx_correction"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );
      histosTH1F["t_proton_minus_newbinning"]->Fill( fabs(t_proton_minus) , event_weight );
      ...
      histosTH2F["proton_minus_xi_vs_t"]->Fill( fabs(t_proton_minus) , xi_proton_minus , event_weight );
         ...
         if(fabs(t_proton_minus)>0.03 && fabs(t_proton_minus)<0.06){histosTH1F["t_proton_minus_vtx_correction_tbin1"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.06 && fabs(t_proton_minus)<0.09){histosTH1F["t_proton_minus_vtx_correction_tbin2"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.09 && fabs(t_proton_minus)<0.13){histosTH1F["t_proton_minus_vtx_correction_tbin3"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.13 && fabs(t_proton_minus)<0.16){histosTH1F["t_proton_minus_vtx_correction_tbin4"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.16 && fabs(t_proton_minus)<0.19){histosTH1F["t_proton_minus_vtx_correction_tbin5"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.19 && fabs(t_proton_minus)<0.24){histosTH1F["t_proton_minus_vtx_correction_tbin6"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.24 && fabs(t_proton_minus)<0.30){histosTH1F["t_proton_minus_vtx_correction_tbin7"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.30 && fabs(t_proton_minus)<0.36){histosTH1F["t_proton_minus_vtx_correction_tbin8"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.36 && fabs(t_proton_minus)<0.45){histosTH1F["t_proton_minus_vtx_correction_tbin9"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.45 && fabs(t_proton_minus)<0.65){histosTH1F["t_proton_minus_vtx_correction_tbin10"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
         if(fabs(t_proton_minus)>0.65 && fabs(t_proton_minus)<1.0){histosTH1F["t_proton_minus_vtx_correction_tbin11"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );}
...
bool proton_minus_rp_accept = ( proton_minus_rp_accept_120 && proton_minus_rp_accept_124 ) || ( proton_minus_rp_accept_121 && proton_minus_rp_accept_125 );
      ...
      if(!proton_minus_rp_accept)continue;
         ...
         histosTH1F["t_proton_minus_accepted_vtx_correction"]->Fill( fabs(t_proton_minus) , vtx_zpos_correction );
         histosTH1F["t_proton_minus_accepted_newbinning"]->Fill( fabs(t_proton_minus) , event_weight );
...
//   Double_t scale_PF = 1.0/f3;
  ...
  histosTH1F["Mass_Jet"]->Scale(scale);
   histosTH1F["t_proton_minus_vtx_correction"]->Scale(scale);
