...
*/
void CMS_MC_POMWIG_plus_vertex_correction(string const& outputFileName = "mc_pomwig_plus_vertex_correction.root", const Int_t nevt_max = -1){
...
//      histosTH1F["hltTrigFired"]->GetXaxis()->SetBinLabel( (k + 1) , hltPathNames[k].c_str() );
  ...
  histosTH1F["xi_proton_plus"] = new TH1F("xi_proton_plus", "xi_proton_plus" , 50, xi_bins);
  ...
  histosTH1F["xi_proton_plus_accepted"] = new TH1F("xi_proton_plus_accepted", "xi_proton_plus" , 50, xi_bins);
