...
void CMS_MC_POMWIG_minus_gen(string const& outputFileName = "mc_pomwig_minus_gen.root", const Int_t nevt_max = -1){
...
//  Float_t tbins[12] = {0.03, 0.06, 0.09, 0.13, 0.16, 0.19, 0.24, 0.30, 0.36, 0.45, 0.65, 1.};//v3
  ...
  histosTH1F["t_proton_minus"] = new TH1F("t_proton_minus", "t_proton_minus" , 22, tbins);
  ...
  histosTH1F["t_proton_minus_accepted"] = new TH1F("t_proton_minus_accepted", "t_proton_minus" , 22, tbins);
