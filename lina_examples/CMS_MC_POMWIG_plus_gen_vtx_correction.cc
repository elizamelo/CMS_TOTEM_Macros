...
void CMS_MC_POMWIG_plus_gen_vtx_correction(string const& outputFileName = "mc_pomwig_plus_gen_vtx_correction.root", const Int_t nevt_max = -1){
...
//  Float_t tbins[12] = { 0.025, 0.05, 0.08, 0.12, 0.15, 0.18, 0.23, 0.30, 0.36, 0.45, 0.65, 1.};
...
//  Float_t tbins[23] = {  0.03, 0.06, 0.09, 0.13, 0.16, 0.19, 0.24, 0.30, 0.36, 0.45, 0.65, 1., 1.0816, 1.1664, 1.2544, 1.3456, 1.44, 1.5376, 1.6384, 1.7424, 1.8496, 1.96, 2.0736};
  ...
  histosTH1F["t_proton_plus_vtx_correction"] = new TH1F("t_proton_plus_vtx_correction", "t_proton_plus" , 11, tbins);
  histosTH1F["t_proton_plus_newbinning"] = new TH1F("t_proton_plus_newbinning", "t_proton_plus" , 33, tbins_matrix);
  histosTH1F["t_proton_plus_vtx_correction_newbinning"] = new TH1F("t_proton_plus_vtx_correction_newbinning", "t_proton_plus" , 33, tbins_matrix);
  histosTH1F["t_proton_plus_accepted"] = new TH1F("t_proton_plus_accepted", "t_proton_plus" , 11, tbins);
  histosTH1F["xi_proton_plus_accepted"] = new TH1F("xi_proton_plus_accepted", "xi_proton_plus" , 200, 0., 1.);
  histosTH1F["t_proton_plus_accepted_vtx_correction"] = new TH1F("t_proton_plus_accepted_vtx_correction", "t_proton_plus" , 11, tbins);
  histosTH1F["t_proton_plus_accepted_newbinning"] = new TH1F("t_proton_plus_accepted_newbinning", "t_proton_plus" , 33, tbins_matrix);
  histosTH1F["t_proton_plus_accepted_vtx_correction_newbinning"] = new TH1F("t_proton_plus_accepted_vtx_correction_newbinning", "t_proton_plus" , 33, tbins_matrix);
...
//       if(!PF_eta_min) continue;
      ...
      histosTH1F["t_proton_plus_vtx_correction"]->Fill( fabs(t_proton_plus) , vtx_zpos_correction );
      histosTH1F["t_proton_plus_vtx_correction_newbinning"]->Fill( fabs(t_proton_plus) , vtx_zpos_correction );
     ...
     bool proton_plus_rp_accept = ( proton_plus_rp_accept_020 && proton_plus_rp_accept_024 ) || ( proton_plus_rp_accept_021 && proton_plus_rp_accept_025 );
      ...
      histosTH1F["t_proton_plus_accepted_vtx_correction"]->Fill( fabs(t_proton_plus) , vtx_zpos_correction );
      histosTH1F["t_proton_plus_accepted_vtx_correction_newbinning"]->Fill( fabs(t_proton_plus) , vtx_zpos_correction );
